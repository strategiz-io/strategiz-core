...
/**
 * Entity for account recovery requests stored in recovery_requests collection. Tracks the
 * multi-step recovery process: email verification, optional SMS verification.
 *
 * <p>
 * Recovery flow:
 * </p>
...
public class RecoveryRequestEntity extends BaseEntity {
	...
	/**
	 * Check if recovery is ready to issue a token. Either: email verified + no MFA
	 * required Or: email verified + SMS verified
	 */
