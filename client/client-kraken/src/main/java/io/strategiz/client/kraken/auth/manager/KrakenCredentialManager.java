package io.strategiz.client.kraken.auth.manager;
...
/**
 * Manager for Kraken API credentials in Vault
 */
@Service
public class KrakenCredentialManager {
    
    private static final Logger log = LoggerFactory.getLogger(KrakenCredentialManager.class);
    ...
    public KrakenCredentialManager(@Qualifier("vaultSecretService") SecretManager secretManager) {
