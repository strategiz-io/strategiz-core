...
public class KrakenBalance {
	...
	public boolean equals(Object o) {
		...
		return Double.compare(that.balanceValue, balanceValue) == 0 && Double.compare(that.usdValue, usdValue) == 0
				&& Objects.equals(asset, that.asset) && Objects.equals(balance, that.balance);
	}
	...
	public String toString() {
		return "KrakenBalance{" + "asset='" + asset + '\'' + ", balance='" + balance + '\'' + ", balanceValue="
				+ balanceValue + ", usdValue=" + usdValue + '}';
	}
