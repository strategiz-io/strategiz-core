 ...
 * to use Spring features if needed.
 *
 * Test Properties:
 ...
 *
 * Mock Beans:
 * - PasetoTokenValidator: Mocked to prevent Vault initialization errors
 *   (the real bean's @PostConstruct init() method requires Vault credentials)
 */
...
public class CucumberSpringConfiguration {
     ...
     *
     * The real PasetoTokenValidator has an @PostConstruct init() method that
     * requires Vault keys to be loaded. By mocking it with @MockBean, we
     * prevent Spring from attempting to initialize it and avoid the
     * StrategizException: CONFIGURATION_ERROR that would occur.
     */
    @MockBean
