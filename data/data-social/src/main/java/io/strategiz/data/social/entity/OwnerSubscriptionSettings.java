...
/**
 * Entity representing an owner's subscription settings. Owners can enable subscriptions
 * to allow others to subscribe and deploy their PUBLIC strategies.
 *
 * <p>
...
public class OwnerSubscriptionSettings extends BaseEntity {
	...
	private String profilePitch; // Marketing pitch shown on public profile (max 500
									// chars)
	...
	/**
	 * @deprecated Use {@link #getNetRevenue(BigDecimal)} instead. Fee is now
	 * configurable.
	 */
	...
	/**
	 * @deprecated Use {@link #getNetMonthlyRevenue(BigDecimal)} instead. Fee is now
	 * configurable.
	 */
	@Deprecated(forRemoval = true)
	...
	public String toString() {
		return "OwnerSubscriptionSettings{" + "id='" + id + '\'' + ", userId='" + userId + '\'' + ", enabled=" + enabled
				+ ", monthlyPrice=" + monthlyPrice + ", subscriberCount=" + subscriberCount + ", stripeConnectStatus='"
				+ stripeConnectStatus + '\'' + '}';
	}
