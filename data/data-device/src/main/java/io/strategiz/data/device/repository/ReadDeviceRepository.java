...
/**
 * Repository interface for all device read operations Groups both authenticated and
 * anonymous device queries Single Responsibility: Device retrieval/querying
 *
...
public interface ReadDeviceRepository {
	...
	/**
	 * Find an authenticated device by ID Reads from: /users/{userId}/devices/{deviceId}
