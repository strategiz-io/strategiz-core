...
public class PushAuthRequestRepositoryImpl extends BaseRepository<PushAuthRequestEntity>
    ...
    public List<PushAuthRequestEntity> findPendingByUserId(String userId) {
        try {
            ...
            throw new DataRepositoryException(DataRepositoryErrorDetails.FIRESTORE_OPERATION_INTERRUPTED, e, "PushAuthRequestEntity");
        } catch (ExecutionException e) {
            throw new DataRepositoryException(DataRepositoryErrorDetails.QUERY_EXECUTION_FAILED, e, "PushAuthRequestEntity", userId);
        }
    }
    ...
    public int markExpired() {
        try {
            ...
            throw new DataRepositoryException(DataRepositoryErrorDetails.QUERY_EXECUTION_FAILED, e, "PushAuthRequestEntity", "expired");
        }
    }
    ...
    public int deleteOldRequests(int olderThanHours) {
        try {
            ...
            Query query = getCollection()
                    .whereLessThan("createdDate", cutoffTimestamp);
            ...
            throw new DataRepositoryException(DataRepositoryErrorDetails.QUERY_EXECUTION_FAILED, e, "PushAuthRequestEntity", "old");
        }
    }
}
