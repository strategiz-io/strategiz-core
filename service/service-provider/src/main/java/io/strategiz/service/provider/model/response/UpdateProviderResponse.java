...
/**
 * Response model for updating provider connections.
 * Contains results of OAuth completion, token refresh, or configuration updates.
 */
public class UpdateProviderResponse {
    ...
    private String action; // "oauth_complete", "refresh_token", "update_config", "sync_data"
