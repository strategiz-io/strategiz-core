...
public class CoinbaseResponse<T> {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(data, that.data) && Objects.equals(pagination, that.pagination);
	}
	...
	public String toString() {
		return "CoinbaseResponse{" + "data=" + data + ", pagination=" + pagination + '}';
	}
	...
	public static class Pagination {
		...
		public Pagination(String ending_before, String starting_after, String previous_uri, String next_uri, int limit,
				String order) {
		...
		public boolean equals(Object o) {
			...
			return limit == that.limit && Objects.equals(ending_before, that.ending_before)
					&& Objects.equals(starting_after, that.starting_after)
					&& Objects.equals(previous_uri, that.previous_uri) && Objects.equals(next_uri, that.next_uri)
		...
		@Override
		public String toString() {
			return "Pagination{" + "ending_before='" + ending_before + '\'' + ", starting_after='" + starting_after
					+ '\'' + ", previous_uri='" + previous_uri + '\'' + ", next_uri='" + next_uri + '\'' + ", limit="
					+ limit + ", order='" + order + '\'' + '}';
		}
