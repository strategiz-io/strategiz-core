...
public class ServiceAccountService {
	...
	public ServiceAccountService(ServiceAccountRepository serviceAccountRepository, PasetoTokenIssuer tokenIssuer) {
	...
	public ServiceAccountTokenResult generateToken(String clientId, String clientSecret, List<String> requestedScopes,
			Duration requestedValidity, String clientIp) {
		...
		String accessToken = tokenIssuer.createToken(tokenSubject, validity,
				PasetoTokenIssuer.TokenType.ACCESS, scopeArray);
	 ...
	 */
	public static class ServiceAccountAuthenticationException extends RuntimeException {
