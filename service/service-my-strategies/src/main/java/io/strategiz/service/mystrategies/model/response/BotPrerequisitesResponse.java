...
/**
 * Response model for bot deployment prerequisites check.
 * Returns information about the user's trading provider connection status.
 */
public class BotPrerequisitesResponse {
    ...
    public BotPrerequisitesResponse(boolean alpacaConnected, String alpacaEnvironment, boolean canDeployBot, String message) {
    ...
    public static BotPrerequisitesResponse notConnected() {
        return new BotPrerequisitesResponse(
                false,
                null,
                false,
    ...
    public static BotPrerequisitesResponse error(String errorMessage) {
        return new BotPrerequisitesResponse(
                ...
                null,
                false,
                "Alpaca connection error: " + errorMessage
        );
    }
