 ...
 *
 * Comments can only be added to published (public) strategies. Supports threaded replies
 * via parentCommentId.
 */
...
public class StrategyCommentEntity extends BaseEntity {
	...
	public String toString() {
		return "StrategyCommentEntity{" + "id='" + id + '\'' + ", strategyId='" + strategyId + '\'' + ", userId='"
				+ userId + '\'' + ", content='"
				+ (content != null && content.length() > 50 ? content.substring(0, 50) + "..." : content) + '\''
				+ ", parentCommentId='" + parentCommentId + '\'' + ", likeCount=" + likeCount + ", commentedAt="
				+ commentedAt + ", isActive=" + getIsActive() + '}';
	}
