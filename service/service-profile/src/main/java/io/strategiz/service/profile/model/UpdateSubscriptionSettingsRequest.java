...
/**
 * Request DTO for updating owner subscription settings. All fields are optional - only
...
public class UpdateSubscriptionSettingsRequest {
	...
	// Default constructor
	public UpdateSubscriptionSettingsRequest() {
	}

	// Constructor with all fields
	public UpdateSubscriptionSettingsRequest(BigDecimal monthlyPrice, String profilePitch) {
