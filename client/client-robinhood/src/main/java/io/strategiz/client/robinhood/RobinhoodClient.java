...
/**
 * Main client for interacting with the Robinhood API. This class coordinates OAuth
 * operations and data retrieval.
 *
 * Note: This is an unofficial API integration. Robinhood may change it at any time.
 *
 * Key features: - Password grant OAuth flow with MFA support - Portfolio and position
 * data retrieval - Stock quote fetching - Crypto holdings (via Nummus)
 */
@Component
