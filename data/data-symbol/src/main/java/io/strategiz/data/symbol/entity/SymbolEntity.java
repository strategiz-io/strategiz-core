 ...
 * - Collection: "symbols"
 * - Document ID: canonical symbol (e.g., "BTC", "AAPL", "ETH")
 *
 * This stores:
 * - Symbol metadata (name, category, description)
 * - Cross-exchange symbol mappings (e.g., BTC -> BTC-USD on Yahoo, BTCUSDT on Binance)
 * - Data collection tracking (which symbols are being collected, last collected timestamp)
 */
@Collection("symbols")
public class SymbolEntity extends BaseEntity {
    ...
    // e.g., {"YAHOO": "BTC-USD", "ALPACA": "BTC/USD", "COINBASE": "BTC-USD", "BINANCE": "BTCUSDT"}
