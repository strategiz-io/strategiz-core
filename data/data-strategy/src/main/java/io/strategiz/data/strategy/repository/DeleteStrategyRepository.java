...
/**
 * Repository interface for deleting strategy entities
...
public interface DeleteStrategyRepository {
    ...
    /**
     * Delete all strategies for a user (soft delete)
     * Warning: This is a dangerous operation and should be used carefully
     */
    int deleteAllByUserId(String userId);
    
    /**
     * Permanently delete a strategy (hard delete)
