...
/**
 * Admin controller for managing feature flags. Allows administrators to enable/disable
...
public class AdminFeatureFlagController extends BaseController {
	...
	public ResponseEntity<Map<String, Object>> getFlagsByCategory(@PathVariable String category,
	...
	public ResponseEntity<?> getFlag(@PathVariable String flagId, HttpServletRequest request) {
		if (featureFlagService == null) {
			return serviceUnavailable();
		}
		String adminUserId = (String) request.getAttribute("adminUserId");
	...
	public ResponseEntity<Map<String, Object>> isEnabled(@PathVariable String flagId, HttpServletRequest request) {
		if (featureFlagService == null) {
			return serviceUnavailable();
		}
		String adminUserId = (String) request.getAttribute("adminUserId");
	...
	public ResponseEntity<?> enableFlag(@PathVariable String flagId, HttpServletRequest request) {
		if (featureFlagService == null) {
			return serviceUnavailable();
		}
		String adminUserId = (String) request.getAttribute("adminUserId");
	...
	public ResponseEntity<?> disableFlag(@PathVariable String flagId, HttpServletRequest request) {
		if (featureFlagService == null) {
			return serviceUnavailable();
		}
		String adminUserId = (String) request.getAttribute("adminUserId");
	...
	public ResponseEntity<?> updateFlag(@PathVariable String flagId, @RequestBody FeatureFlagEntity flagUpdate,
			HttpServletRequest request) {
		if (featureFlagService == null) {
			return serviceUnavailable();
		}
	...
	public ResponseEntity<?> createFlag(@RequestBody FeatureFlagEntity flag, HttpServletRequest request) {
		if (featureFlagService == null) {
			return serviceUnavailable();
		}
		String adminUserId = (String) request.getAttribute("adminUserId");
	...
	public ResponseEntity<Map<String, Object>> deleteFlag(@PathVariable String flagId, HttpServletRequest request) {
		if (featureFlagService == null) {
			return serviceUnavailable();
		}
		String adminUserId = (String) request.getAttribute("adminUserId");
