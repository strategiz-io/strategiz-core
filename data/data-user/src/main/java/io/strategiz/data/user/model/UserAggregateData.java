...
/**
 * Aggregated user data containing main user document + all subcollections This is a
 * composite DTO that delegates to other data modules for subcollection data
 */
public class UserAggregateData {
	...
	private Object preferences; // TODO: Will be typed when data-preferences module is
								// updated
