package io.strategiz.api.monitoring.controller;

import io.strategiz.api.monitoring.model.StatusResponse;
...
public class HealthCheckController {
    ...
    public Map<String, Object> versionInfo() {
        ...
        response.put("version", "1.0.0"); // This would come from a properties file in a real implementation
