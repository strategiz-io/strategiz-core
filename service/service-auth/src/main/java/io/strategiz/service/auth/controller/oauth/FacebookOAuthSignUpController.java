...
/**
 * Controller for handling Facebook OAuth sign-up flow Specifically for new users creating
...
public class FacebookOAuthSignUpController extends BaseController {
	...
	public ResponseEntity<Map<String, String>> getAuthorizationUrl() {
		Map<String, String> authInfo = facebookOAuthService.getAuthorizationUrl(true); // isSignup
																						// =
																						// true
	...
	public ResponseEntity<Map<String, Object>> handleCallbackJson(@RequestBody Map<String, String> callbackRequest,
		...
		try {
			...
			Map<String, Object> errorResponse = Map.of("success", false, "error", e.getMessage(), "message",
					"Facebook OAuth sign-up callback failed");
