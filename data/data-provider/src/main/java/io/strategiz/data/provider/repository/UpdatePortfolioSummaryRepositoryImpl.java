...
public class UpdatePortfolioSummaryRepositoryImpl implements UpdatePortfolioSummaryRepository {
    ...
    @Autowired
    public UpdatePortfolioSummaryRepositoryImpl(
            PortfolioSummaryBaseRepository baseRepository,
    ...
    @Override
    public PortfolioSummaryEntity updateAssetAllocation(String userId, PortfolioSummaryEntity.AssetAllocation assetAllocation) {
        // Get existing summary
        PortfolioSummaryEntity existing = readRepository.getPortfolioSummary(userId);
        if (existing == null) {
            throw new RuntimeException("Portfolio summary not found for update: " + userId);
