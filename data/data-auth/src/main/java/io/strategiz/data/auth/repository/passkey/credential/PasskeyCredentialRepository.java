...
/**
 * Repository interface for managing passkey credentials Provides CRUD operations for
 * passkey credentials
 */
@Repository
public interface PasskeyCredentialRepository extends CrudRepository<PasskeyCredentialEntity, String> {
	...
	/**
	 * Find all credentials for a user (this would typically be done through a
