...
/**
 * DTO for market data bars returned to the frontend Represents a single OHLCV data point
 * for charting
 */
public class MarketDataBarDTO {
	...
	// Full constructor
	public MarketDataBarDTO(String symbol, String timestamp, BigDecimal open, BigDecimal high, BigDecimal low,
			BigDecimal close, BigDecimal volume, String timeframe) {
		this.symbol = symbol;
	...
	public static MarketDataBarDTO fromEntity(MarketDataEntity entity) {
		...
		if (entity.getTimestamp() != null) {
			...
			String isoTimestamp = instant.atZone(ZoneId.of("UTC")).format(DateTimeFormatter.ISO_INSTANT);
	...
	public String toString() {
		return String.format("MarketDataBarDTO[symbol=%s, timestamp=%s, close=%.2f, volume=%.0f]", symbol, timestamp,
				close, volume);
	}
