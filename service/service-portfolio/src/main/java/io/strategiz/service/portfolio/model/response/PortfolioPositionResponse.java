...
/**
 * Represents a single position/asset in a portfolio.
 * Used across all providers for consistent UI display.
 */
public class PortfolioPositionResponse {
    ...
    private BigDecimal profitLoss;      // currentValue - costBasis (Unrealized Return in Kraken)
