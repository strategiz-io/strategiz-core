 ...
 * 
 * Contains user ID and temporary session token to proceed to Step 2 (authentication setup).
 * This token has limited permissions - only allows authentication method setup.
 */
