...
public class Strategy extends BaseEntity {
	...
	private String normalizedName; // Lowercase, trimmed version for case-insensitive
									// uniqueness checks
	...
	private Map<String, Object> visualRules; // Visual strategy builder configuration
												// (JSON)
	...
	private Timestamp seedFundingDate; // Optional custom backtest start date for
	...
	/**
	 * Check if strategy is PRIVATE (only owner can see). Private when: not published OR
