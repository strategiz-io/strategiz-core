...
/**
 * Response for TOTP authentication (login) Contains authentication tokens upon successful
 * verification
 */
public record TotpAuthenticationResponse(boolean success, String accessToken, String refreshToken, String message) {
	/**
