...
/**
 * Exception class for data-strategy module operations.
 * Extends StrategizException for integration with the global exception handling framework.
 *
 * Usage:
 * throw new DataStrategyException(DataStrategyErrorDetails.STRATEGY_NOT_FOUND, "data-strategy", strategyId);
 * throw new DataStrategyException(DataStrategyErrorDetails.ALERT_QUERY_FAILED, "data-strategy", e, strategyId, e.getMessage());
 */
public class DataStrategyException extends StrategizException {
	 ...
	 * @param args Optional arguments for message formatting (e.g., strategy ID, error message)
	 */
