 ...
 * 
 * Each error maps to properties in service-marketing-errors.properties file which contains:
 * - Error code
 ...
 * 
 * Usage:
 * throw new StrategizException(ServiceMarketingErrorDetails.MARKET_DATA_UNAVAILABLE, "service-marketing", symbol);
 * throw new StrategizException(ServiceMarketingErrorDetails.API_RATE_LIMIT_EXCEEDED, "service-marketing", "CoinGecko", "60", "requests per minute");
 */
public enum ServiceMarketingErrorDetails implements ErrorDetails {
    ...
    ServiceMarketingErrorDetails(HttpStatus httpStatus, String propertyKey) {
