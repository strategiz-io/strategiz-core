 ...
 *
 * <p>Provides mock OAuth credentials and clients for testing without connecting to Vault
 * or external OAuth providers. This configuration is loaded in place of OAuthVaultConfig
...
public class TestOAuthConfig {
     ...
     *
     * <p>Adds mock OAuth credentials to the Spring environment so that
     * OAuth provider services can be instantiated in tests.</p>
     */
    @Bean
    @Primary
     ...
     *
     * <p>Returns a Mockito mock that can be configured in individual tests
     * as needed.</p>
     */
    @Bean
    @Primary
