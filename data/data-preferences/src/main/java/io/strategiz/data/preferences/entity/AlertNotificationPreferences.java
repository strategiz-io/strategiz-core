...
public class AlertNotificationPreferences extends BaseEntity {
    ...
    /**
     * Check if SMS notifications are properly configured (phone verified and channel enabled).
     */
    ...
    public boolean isEmailConfigured() {
        return emailForAlerts != null && !emailForAlerts.isEmpty()
    ...
    public boolean isWithinRateLimit() {
        return alertsThisHour == null || maxAlertsPerHour == null
                || alertsThisHour < maxAlertsPerHour;
    }
}
