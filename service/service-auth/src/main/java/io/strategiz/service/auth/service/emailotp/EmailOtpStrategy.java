...
/**
 * Production implementation of EmailOTP authentication strategy.
 * This implementation sends actual email OTPs to users.
...
public class EmailOtpStrategy implements AuthMethodStrategy {
    ...
    public Object setupAuthentication(User user) {
        ...
        // Note: In a more advanced implementation, we would want to pass template variables
