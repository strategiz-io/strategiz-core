 ...
 *
 * Webull uses App Key and App Secret for authentication. Account ID is required for
...
public class WebullApiCredentials {
	...
	public String toString() {
		return "WebullApiCredentials{" + "appKey='"
				+ (appKey != null ? appKey.substring(0, Math.min(appKey.length(), 4)) + "****" : null) + '\''
				+ ", hasAccountId=" + (accountId != null && !accountId.isEmpty()) + ", userId='" + userId + '\'' + '}';
	}
