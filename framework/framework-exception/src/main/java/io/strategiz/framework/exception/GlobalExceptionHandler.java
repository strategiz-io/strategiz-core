 ...
 *
 * <p>In the hybrid approach: - BaseController handles StrategizException (business exceptions) -.
 * GlobalExceptionHandler handles system exceptions (unexpected errors).
 *
 * <p>This provides a safety net for exceptions that fall through BaseController.
 *
 * <p>Order is set to LOWEST_PRECEDENCE to ensure BaseController's @ExceptionHandler methods are.
 * tried first for controllers that extend BaseController.
 */
@ControllerAdvice
...
public class GlobalExceptionHandler {
  ...
  /**
   * Handle StrategizException that falls through BaseController This should rarely be called -.
   * mainly for controllers that don't extend BaseController.
   */
