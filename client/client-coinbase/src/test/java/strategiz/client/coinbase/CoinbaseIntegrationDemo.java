...
/**
 * Comprehensive demonstration of the Coinbase API integration
 * This connects to the real Coinbase API to fetch actual cryptocurrency data
 */
public class CoinbaseIntegrationDemo {

    // List of cryptocurrencies to fetch prices for
    private static final List<String> CRYPTOCURRENCIES = Arrays.asList(
            "BTC", "ETH", "SOL", "ADA", "DOT", "AVAX", "MATIC", "LINK", "UNI", "XRP"
    );
