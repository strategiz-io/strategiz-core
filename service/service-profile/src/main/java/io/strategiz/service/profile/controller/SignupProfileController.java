...
/**
 * Controller for profile creation during signup flow. Handles profile creation with
 * initial user data. Uses clean architecture - returns resources directly, no wrappers.
 */
@RestController
...
public class SignupProfileController extends BaseController {
	 ...
	 * @return Clean profile creation response with user ID and token - no wrapper, let
