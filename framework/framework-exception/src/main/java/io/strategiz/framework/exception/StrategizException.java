...
/**
 * Base exception class for all Strategiz application exceptions. Enforces the use of enum error.
 * codes for consistency.
 *
 * <p>Enhanced to support ErrorDetails interface for structured error information.
 */
public class StrategizException extends RuntimeException {
  ...
  public StrategizException(
      ErrorDetails errorDetails, String moduleName, Throwable cause, Object... args) {
