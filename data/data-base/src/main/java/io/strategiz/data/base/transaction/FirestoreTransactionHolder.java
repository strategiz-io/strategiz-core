...
/**
 * Holds the current Firestore transaction in a ThreadLocal for use across repository operations.
 * This allows Spring's @Transactional to manage Firestore transactions declaratively.
 */
