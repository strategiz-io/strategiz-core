...
public class UserActivityEntity extends BaseEntity {
	...
	public String toString() {
		return "UserActivityEntity{" + "id='" + id + '\'' + ", userId='" + userId + '\'' + ", activityType='"
				+ activityType + '\'' + ", title='" + title + '\'' + ", activityDate=" + activityDate + ", visibility='"
				+ visibility + '\'' + ", isActive=" + getIsActive() + '}';
	}
