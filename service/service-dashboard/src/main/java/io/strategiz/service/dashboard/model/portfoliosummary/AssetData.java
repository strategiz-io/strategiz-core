...
public class AssetData {
    ...
    public AssetData(String symbol, String name, BigDecimal quantity, BigDecimal price,
                    BigDecimal value, BigDecimal allocationPercent, BigDecimal dailyChange,
    ...
    public static class Builder {
        ...
        public Builder withAllocationPercent(BigDecimal allocationPercent) { this.allocationPercent = allocationPercent; return this; }
        ...
        public AssetData build() {
            return new AssetData(symbol, name, quantity, price, value, allocationPercent, dailyChange, dailyChangePercent);
        }
    }
}
