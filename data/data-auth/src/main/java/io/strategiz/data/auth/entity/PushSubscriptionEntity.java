...
/**
 * Entity for Web Push subscriptions stored in push_subscriptions collection.
 * Stores the Web Push API subscription data needed to send push notifications.
 *
 * <p>Each subscription represents a browser/device that can receive push notifications.
 * Users can have multiple subscriptions (multiple browsers/devices).</p>
 *
 * <p>Subscription data from Web Push API:</p>
 * <ul>
...
public class PushSubscriptionEntity extends BaseEntity {
     ...
     * This is where we send push messages.
     */
    ...
    /**
     * User-friendly name for this device/browser.
     * e.g., "Chrome on MacBook", "Firefox on iPhone"
     */
    ...
    /**
     * Whether push auth is enabled for this subscription.
     * User can disable without removing the subscription.
     */
    ...
    /**
     * Count of failed push attempts.
     * Used to detect stale subscriptions.
     */
    ...
    /**
     * Get a hash of the endpoint for quick lookup.
     * Useful for finding existing subscriptions.
     */
