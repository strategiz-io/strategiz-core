...
public class FirestoreService {
    ...
    public Map<String, String> getBinanceUSCredentials(String userId) {
        ...
        try {
            ...
            log.error("Error retrieving Binance US credentials: {}", e.getMessage(), e);
            return null;
        }
    }
    ...
    public void saveBinanceUSCredentials(String userId, String apiKey, String secretKey) {
        ...
        try {
            ...
            if (!querySnapshot.isEmpty()) {
                ...
                log.info("Updated existing Binance US credentials in api_credentials subcollection for user: {}", userId);
            } else {
                // Create new document
                FirestoreClient.getFirestore()
                    .collection("users")
                ...
                log.info("Created new Binance US credentials in api_credentials subcollection for user: {}", userId);
            }
        } catch (Exception e) {
    ...
    private void migrateToNewStructure(String userId, String apiKey, String secretKey) {
        try {
            ...
            log.error("Error migrating Binance US credentials: {}", e.getMessage(), e);
        }
    }
}
