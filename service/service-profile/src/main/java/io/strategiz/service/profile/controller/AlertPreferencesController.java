...
/**
 * Controller for managing alert notification preferences.
 * Provides endpoints for configuring phone number, email, channels, and quiet hours.
 */
@RestController
...
public class AlertPreferencesController extends BaseController {
    ...
    /**
     * Initiate phone verification for SMS alerts.
    ...
    public ResponseEntity<Map<String, Object>> confirmPhoneVerification(
        ...
        return ResponseEntity.ok(Map.of("verified", true, "phoneNumber",
                maskPhoneNumber(updated.getPhoneNumber())));
    }
    ...
    private boolean isValidChannel(String channel) {
        return channel != null
                && (channel.equalsIgnoreCase("email") || channel.equalsIgnoreCase("sms")
