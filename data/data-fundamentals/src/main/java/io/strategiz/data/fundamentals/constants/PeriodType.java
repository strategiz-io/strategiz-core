 ...
 *
 * Fundamentals can be reported on different time periods:
 * - QUARTERLY: Quarterly financial reports (Q1, Q2, Q3, Q4)
 * - ANNUAL: Annual financial reports (fiscal year)
...
public final class PeriodType {
     ...
     */
    public static final Set<String> VALID_PERIOD_TYPES = new HashSet<>(Arrays.asList(
        QUARTERLY,
        ANNUAL,
        TTM
    ));
