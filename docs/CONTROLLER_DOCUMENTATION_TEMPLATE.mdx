...
> **[📊 Open in draw.io](diagrams/[api-name]-components.drawio)**
...
<mxfile host="app.diagrams.net">
  <diagram name="[Component Name]" id="[unique-id]">
    ...
    <!-- Shows: Service Layer, Business Layer, Client Layer, External Systems -->
  </diagram>
</mxfile>
```
...
> **[📊 Open in draw.io](diagrams/[api-name]-flow.drawio)**
> *Click above to edit this diagram in draw.io desktop app or web editor*
...
<mxfile host="app.diagrams.net">
  <diagram name="[Flow Name]" id="[unique-id]">
    <!-- Add draw.io XML here -->
    <!-- Shows: User -> Controller -> Service -> Business -> Client -> External API -->
  </diagram>
</mxfile>
```
