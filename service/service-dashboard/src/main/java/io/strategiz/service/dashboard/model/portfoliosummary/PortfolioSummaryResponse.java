...
public class PortfolioSummaryResponse {
	...
	public PortfolioSummaryResponse(String userId, BigDecimal totalValue, BigDecimal dailyChange,
			BigDecimal dailyChangePercent, BigDecimal weeklyChange, BigDecimal weeklyChangePercent,
			BigDecimal monthlyChange, BigDecimal monthlyChangePercent, BigDecimal yearlyChange,
			BigDecimal yearlyChangePercent, List<Asset> assets, LocalDateTime lastUpdated,
			boolean hasExchangeConnections, String statusMessage, boolean needsApiKeyConfiguration,
	...
	public boolean equals(Object o) {
		...
		return hasExchangeConnections == that.hasExchangeConnections
				&& needsApiKeyConfiguration == that.needsApiKeyConfiguration && Objects.equals(userId, that.userId)
				&& Objects.equals(totalValue, that.totalValue) && Objects.equals(dailyChange, that.dailyChange)
				...
				&& Objects.equals(yearlyChangePercent, that.yearlyChangePercent) && Objects.equals(assets, that.assets)
				&& Objects.equals(lastUpdated, that.lastUpdated) && Objects.equals(statusMessage, that.statusMessage)
				&& Objects.equals(exchanges, that.exchanges) && Objects.equals(portfolioMetrics, that.portfolioMetrics);
	}

	@Override
	public int hashCode() {
		return Objects.hash(userId, totalValue, dailyChange, dailyChangePercent, weeklyChange, weeklyChangePercent,
				monthlyChange, monthlyChangePercent, yearlyChange, yearlyChangePercent, assets, lastUpdated,
				hasExchangeConnections, statusMessage, needsApiKeyConfiguration, exchanges, portfolioMetrics);
	}

	@Override
	public String toString() {
		return "PortfolioSummaryResponse{" + "userId='" + userId + '\'' + ", totalValue=" + totalValue
				+ ", dailyChange=" + dailyChange + ", dailyChangePercent=" + dailyChangePercent + ", weeklyChange="
				+ weeklyChange + ", weeklyChangePercent=" + weeklyChangePercent + ", monthlyChange=" + monthlyChange
				+ ", monthlyChangePercent=" + monthlyChangePercent + ", yearlyChange=" + yearlyChange
				+ ", yearlyChangePercent=" + yearlyChangePercent + ", assets=" + assets + ", lastUpdated=" + lastUpdated
				+ ", hasExchangeConnections=" + hasExchangeConnections + ", statusMessage='" + statusMessage + '\''
				+ ", needsApiKeyConfiguration=" + needsApiKeyConfiguration + ", exchanges=" + exchanges
	...
	public static class Builder {
		...
		public PortfolioSummaryResponse build() {
			return new PortfolioSummaryResponse(userId, totalValue, dailyChange, dailyChangePercent, weeklyChange,
					weeklyChangePercent, monthlyChange, monthlyChangePercent, yearlyChange, yearlyChangePercent, assets,
					lastUpdated, hasExchangeConnections, statusMessage, needsApiKeyConfiguration, exchanges,
					portfolioMetrics);
		}
