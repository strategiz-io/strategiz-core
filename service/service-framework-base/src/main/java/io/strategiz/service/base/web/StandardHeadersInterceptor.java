 ...
 * - X-Trace-ID: Unique trace for this request/response cycle
 * - X-Request-ID: Client-provided or server-generated request ID  
 * - X-Timestamp: Server timestamp when response was generated
 * - X-API-Version: API version being used
 * - X-Server-ID: Which server instance handled the request
 * - X-Response-Time: How long server took to process (added in postHandle)
 */
@Component
