...
/**
 * Client for fetching data from Coinbase using OAuth access tokens This class handles all
 * account data retrieval operations
 */
@Component
public class CoinbaseDataClient {
	...
	public List<Map<String, Object>> getAccounts(String accessToken) {
		Map<String, Object> response = makeAuthenticatedRequest(HttpMethod.GET, "/accounts", accessToken, null);
	...
	public Map<String, Object> getAccount(String accessToken, String accountId) {
		Map<String, Object> response = makeAuthenticatedRequest(HttpMethod.GET, "/accounts/" + accountId, accessToken,
				null);
	...
	public List<Map<String, Object>> getTransactions(String accessToken, String accountId, Integer limit) {
		...
		Map<String, Object> response = makeAuthenticatedRequest(HttpMethod.GET,
				"/accounts/" + accountId + "/transactions", accessToken, params);
		return extractDataList(response);
	}
	...
	public List<Map<String, Object>> getAllTransactions(String accessToken, Integer limit) {
		...
		Map<String, Object> response = makeAuthenticatedRequest(HttpMethod.GET, "/transactions", accessToken, params);
		return extractDataList(response);
	}
	...
	public Map<String, Object> getBuyPrice(String accessToken, String currencyPair) {
		Map<String, Object> response = makeAuthenticatedRequest(HttpMethod.GET, "/prices/" + currencyPair + "/buy",
				accessToken, null);
		return extractData(response);
	}
	...
	public Map<String, Object> getSellPrice(String accessToken, String currencyPair) {
		Map<String, Object> response = makeAuthenticatedRequest(HttpMethod.GET, "/prices/" + currencyPair + "/sell",
				accessToken, null);
		return extractData(response);
	}
	...
	public Map<String, Object> getSpotPrice(String accessToken, String currencyPair) {
		Map<String, Object> response = makeAuthenticatedRequest(HttpMethod.GET, "/prices/" + currencyPair + "/spot",
				accessToken, null);
		return extractData(response);
	}
	...
	public Map<String, Object> getExchangeRates(String accessToken, String currency) {
		Map<String, Object> response = makeAuthenticatedRequest(HttpMethod.GET, "/exchange-rates?currency=" + currency,
				accessToken, null);
		return extractData(response);
	}
	...
	public List<Map<String, Object>> getPaymentMethods(String accessToken) {
		Map<String, Object> response = makeAuthenticatedRequest(HttpMethod.GET, "/payment-methods", accessToken, null);
		return extractDataList(response);
	}
	 ...
	 */
	private Map<String, Object> makeAuthenticatedRequest(HttpMethod method, String endpoint, String accessToken,
			Map<String, String> params) {
		try {
			// Validate access token
			if (accessToken == null || accessToken.trim().isEmpty()) {
				throw new StrategizException(CoinbaseErrors.AUTHENTICATION_ERROR, "Access token is required");
			}
			...
			if (response.getBody() == null) {
				throw new StrategizException(CoinbaseErrors.INVALID_RESPONSE, "Empty response from Coinbase API");
			}
			...
			throw new StrategizException(CoinbaseErrors.API_ERROR, "Coinbase API error: " + responseBody);
