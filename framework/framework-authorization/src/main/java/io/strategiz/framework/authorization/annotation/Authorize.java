 ...
 *
 * <p>This provides Layer 2 authorization - relationship-based access control.
 * It checks if the authenticated user has a specific relation to a resource.</p>
 *
 * <p>The resourceId supports SpEL expressions to extract values from method parameters:</p>
 * <ul>
 *   <li>{@code #paramName} - Reference a method parameter by name</li>
 *   <li>{@code #request.id} - Reference a property of a parameter</li>
 * </ul>
 *
 * <p>Usage examples:</p>
 * <pre>
