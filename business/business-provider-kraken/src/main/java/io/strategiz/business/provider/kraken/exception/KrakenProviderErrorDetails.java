 ...
 * 
 * Each error maps to properties in business-provider-kraken-errors.properties file which contains:
 * - Error code
 ...
 * 
 * Usage:
 * throw new StrategizException(KrakenProviderErrorDetails.INVALID_CREDENTIALS, "business-provider-kraken", userId);
 * throw new StrategizException(KrakenProviderErrorDetails.BALANCE_FETCH_FAILED, "business-provider-kraken", userId, errorMessage);
 * 
