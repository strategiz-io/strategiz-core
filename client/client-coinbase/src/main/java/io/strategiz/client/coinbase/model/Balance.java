...
public class Balance {
	...
	public boolean equals(Object o) {
		...
		return Double.compare(balance.amountValue, amountValue) == 0 && Double.compare(balance.usdValue, usdValue) == 0
				&& Objects.equals(amount, balance.amount) && Objects.equals(currency, balance.currency);
	}
	...
	public String toString() {
		return "Balance{" + "amount='" + amount + '\'' + ", currency='" + currency + '\'' + ", amountValue="
				+ amountValue + ", usdValue=" + usdValue + '}';
	}
