...
/**
 * Request to approve or deny a push auth request. Called from the device receiving the
 * push notification.
 *
 ...
 */
public record PushAuthRespondRequest(@NotBlank(message = "Challenge is required") String challenge,
