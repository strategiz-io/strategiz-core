...
public class BitcoinTradingAgentController {
    ...
    public ResponseEntity<Map<String, Object>> generateTradingSignal(
        ...
        try {
            ...
            response.put("strengthValue", signal.getStrength().getValue());
