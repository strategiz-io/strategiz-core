...
/**
 * Temporary stub controller for device registration TODO: Remove this once service-device
 * module is fixed and re-enabled
 */
@RestController
...
public class TemporaryDeviceStubController {
	...
	public ResponseEntity<Map<String, Object>> registerDevice(
			@RequestBody(required = false) Map<String, Object> deviceData) {
