 ...
 * Handles various Kraken naming conventions including X/Z prefixes, .F futures, and .S staking suffixes.
 * 
...
public class KrakenSymbolEnricher {
    ...
    public Map<String, Object> normalizeSymbols(Map<String, Object> rawBalances) {
        ...
        for (Map.Entry<String, Object> entry : rawBalances.entrySet()) {
            ...
            // If we already have this normalized symbol (e.g., staked and unstaked versions),
    ...
    public String normalizeSymbol(String krakenSymbol) {
        ...
        Map<String, String> assetMapping = Map.ofEntries(
            Map.entry("XXBT", "BTC"),
            Map.entry("XBT", "BTC"),
            Map.entry("XETH", "ETH"),
            Map.entry("ETH2", "ETH"),     // ETH2 is staked ETH
    ...
    public boolean isStakedAsset(String krakenSymbol) {
        return krakenSymbol != null && (
            krakenSymbol.endsWith(".S") ||  // Liquid staking
    ...
    public boolean isCashAsset(String symbol) {
        return KrakenEnrichmentConstants.CASH_ASSETS.contains(symbol) ||
               KrakenEnrichmentConstants.CASH_ASSETS.contains("Z" + symbol); // Check with Z prefix
    }
}