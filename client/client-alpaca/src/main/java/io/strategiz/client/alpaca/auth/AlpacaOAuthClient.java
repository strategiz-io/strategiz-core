...
/**
 * Client for handling Alpaca OAuth operations.
...
public class AlpacaOAuthClient {
    ...
    public Map<String, Object> exchangeCodeForTokens(String authorizationCode) {
        try {
            ...
            log.error("OAuth token exchange failed with status {}: {}",
    ...
    /**
     * Revoke access token
     * Note: Alpaca doesn't have a specific token revocation endpoint in their OAuth spec.
     * This method is a placeholder for consistency with other providers.
     *
