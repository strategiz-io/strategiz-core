...
/**
 * Repository for AlertNotificationPreferences stored at
 * users/{userId}/preferences/alertNotifications
 */
@Repository
public class AlertNotificationPreferencesRepository extends SubcollectionRepository<AlertNotificationPreferences> {
	...
	/**
	 * Get alert notification preferences for a user. Creates default preferences if none
	 * exist.
	...
	public AlertNotificationPreferences getByUserId(String userId) {
		...
		Optional<AlertNotificationPreferences> existing = findByIdInSubcollection(userId,
				AlertNotificationPreferences.PREFERENCE_ID);
