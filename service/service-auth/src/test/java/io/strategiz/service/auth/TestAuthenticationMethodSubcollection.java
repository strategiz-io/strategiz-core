...
/**
 * Test class to verify that authentication methods are being properly stored in the
 * users/{userId}/authentication_methods subcollection
 */
@SpringBootTest
@ActiveProfiles("test")
public class TestAuthenticationMethodSubcollection {
	...
	public void testSmsOtpSubcollectionCreation() throws ExecutionException, InterruptedException {
		...
		boolean registered = smsOtpRegistrationService.registerPhoneNumber(testUserId, "+1234567890", "127.0.0.1",
				"US");
