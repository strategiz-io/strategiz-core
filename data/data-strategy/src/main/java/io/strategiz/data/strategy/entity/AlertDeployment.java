...
/**
 * Entity representing a deployed strategy alert. Links to a Strategy entity and defines
 * how/when to alert the user.
 *
 * Implements CircuitBreakerState for fault tolerance - alerts are automatically paused
 * when they experience too many consecutive failures.
 *
...
public class AlertDeployment extends BaseEntity implements CircuitBreakerState {
	...
	private Integer cooldownMinutes; // Min time between alerts (default: 15 for FREE, 5
										// for STARTER, 1 for PRO)
	...
	/**
	 * Check if this is an ALERT deployment type AlertDeployment is always an alert
	 * deployment
	 */
	...
	/**
	 * Check if this is a BOT deployment type AlertDeployment is never a bot deployment
	 */
