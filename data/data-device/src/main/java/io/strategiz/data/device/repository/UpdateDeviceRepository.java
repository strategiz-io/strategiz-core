...
/**
 * Repository interface exclusively for device update operations Single Responsibility:
 * Device modification/updates
 */
public interface UpdateDeviceRepository {
	 ...
	 * @return Optional containing updated device if successful
	 */
	Optional<DeviceIdentity> partialUpdateAuthenticatedDevice(String userId, String deviceId,
	 ...
	 * @return Optional containing updated device if successful
	 */
	Optional<DeviceIdentity> partialUpdateAnonymousDevice(String deviceId, Map<String, Object> updates);
	 ...
	 */
	int bulkUpdateAuthenticatedDevices(String userId, String[] deviceIds, Map<String, Object> updates);
	 ...
	 * @return Number of devices updated
	 */
	int updateAuthenticatedDevicesWhere(String userId, Map<String, Object> criteria, Map<String, Object> updates);
	 ...
	 * @return Number of devices updated
	 */
	int updateAnonymousDevicesWhere(Map<String, Object> criteria, Map<String, Object> updates);
