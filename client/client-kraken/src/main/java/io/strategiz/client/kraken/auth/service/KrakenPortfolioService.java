...
/**
 * Service for fetching portfolio data from Kraken
 */
@Service
public class KrakenPortfolioService {
    ...
    public KrakenPortfolioService(
            KrakenApiAuthClient apiAuthClient,
            KrakenCredentialService credentialService) {
    ...
    public Map<String, Object> getPortfolio(String userId) {
        try {
            ...
            KrakenApiCredentials credentials = credentialService.getCredentials(userId);
            if (credentials == null) {
            ...
            Map<String, Object> balanceData = apiAuthClient.getAccountBalance(
    ...
    public Map<String, Object> getBalances(String userId) {
        try {
            ...
            // Fetch balances
            Map<String, Object> response = apiAuthClient.getAccountBalance(
                credentials.getApiKey(), 
                credentials.getApiSecret(),
                credentials.getOtp()
            ).block();
    ...
    public Map<String, Object> getOpenPositions(String userId) {
        try {
            ...
            Map<String, Object> response = apiAuthClient.getPortfolio(
                credentials.getApiKey(), 
                credentials.getApiSecret(),
                credentials.getOtp()
            ).block();
    ...
    public Map<String, Object> getTradeHistory(String userId) {
        try {
            ...
            // Fetch trade history
            Map<String, Object> response = apiAuthClient.getTradeHistory(
                credentials.getApiKey(), 
                credentials.getApiSecret(),
                credentials.getOtp()
            ).block();
