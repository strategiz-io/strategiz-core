...
/**
 * HashiCorp Vault implementation of the SecretManager interface. Uses direct HTTP calls to Vault
 * API instead of Spring Cloud Vault.
 */
@Service
public class VaultSecretService implements SecretManager {
  ...
  public VaultSecretService(
      VaultClient vaultClient, SecretCache secretCache, VaultProperties properties) {
    ...
    try {
      ...
      if (value == null) {
        throw new StrategizException(
            SecretsErrors.SECRET_NOT_FOUND, "Secret field not found: " + key);
      }
      ...
      throw new StrategizException(
          SecretsErrors.VAULT_CONNECTION_FAILED, "Failed to retrieve secret: " + e.getMessage());
    }
  }
  ...
  public void createSecret(String key, String value) {
    try {
      ...
      throw new StrategizException(
          SecretsErrors.VAULT_CONNECTION_FAILED, "Failed to create secret: " + e.getMessage());
    }
  }
  ...
  public void updateSecret(String key, String value) {
    try {
      ...
      throw new StrategizException(
          SecretsErrors.VAULT_CONNECTION_FAILED, "Failed to update secret: " + e.getMessage());
    }
  }
  ...
  public void deleteSecret(String key) {
    try {
      ...
      throw new StrategizException(
          SecretsErrors.VAULT_CONNECTION_FAILED, "Failed to delete secret: " + e.getMessage());
    }
  }
