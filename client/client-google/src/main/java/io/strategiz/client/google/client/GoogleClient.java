package io.strategiz.client.google.client;
...
/**
 * Main client for Google OAuth API interactions. This class orchestrates all Google API
 * calls and extends BaseHttpClient. Ensures we ONLY use real Google API data, never mocks
 * or simulations.
 *
 * Follows SOLID principles: - Single Responsibility: Orchestrates Google OAuth operations
 * - Open/Closed: Open for extension through helper composition - Dependency Inversion:
 * Depends on helper abstractions
 */
@Component
public class GoogleClient extends BaseHttpClient {
	 ...
	 */
	public GoogleClient(GoogleTokenHelper googleTokenHelper, GoogleUserInfoHelper googleUserInfoHelper,
