 ...
 *
 * Alpaca API Response Format: { "id": "b0b6dd9d-8b9b-48a9-ba46-b9d54906e415", "class":
 * "us_equity", "exchange": "NASDAQ", "symbol": "AAPL", "name": "Apple Inc.", "status":
 * "active", "tradable": true, "marginable": true, "shortable": true, "easy_to_borrow":
 * true, "fractionable": true, "min_order_size": "1", "min_trade_increment": "0.01",
...
public class AlpacaAsset {
	...
	public String toString() {
		return String.format("AlpacaAsset[symbol=%s, name=%s, exchange=%s, class=%s, tradable=%b]", symbol, name,
				exchange, assetClass, tradable);
	}
