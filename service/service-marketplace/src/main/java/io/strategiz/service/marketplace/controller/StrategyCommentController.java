 ...
 *
 * Endpoints:
 * - POST   /v1/strategies/{strategyId}/comments           - Add comment
 * - GET    /v1/strategies/{strategyId}/comments           - Get comments
 * - PUT    /v1/strategies/{strategyId}/comments/{id}      - Edit comment
 * - DELETE /v1/strategies/{strategyId}/comments/{id}      - Delete comment
 * - POST   /v1/strategies/{strategyId}/comments/{id}/like - Like comment
 * - DELETE /v1/strategies/{strategyId}/comments/{id}/like - Unlike comment
 * - GET    /v1/strategies/{strategyId}/comments/{id}/replies - Get replies
 * - POST   /v1/strategies/{strategyId}/comments/{id}/replies - Add reply
 *
...
public class StrategyCommentController extends BaseController {
    ...
    @CrossOrigin(origins = {"http://localhost:3000", "http://localhost:3001", "https://strategiz.io"}, allowedHeaders = "*")
    public ResponseEntity<Object> getReplies(
            @PathVariable String strategyId,
            @PathVariable String commentId) {
        try {
    ...
    private ResponseEntity<Object> handleException(Exception e) {
        ...
        if (message != null) {
            ...
            } else if (message.contains("unauthorized") || message.contains("permission") || message.contains("not published")) {
