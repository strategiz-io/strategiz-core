...
public class UpdateProviderDataRepositoryImpl implements UpdateProviderDataRepository {
	...
	@Autowired
	public UpdateProviderDataRepositoryImpl(ProviderDataBaseRepository baseRepository,
	...
	@Override
	public ProviderDataEntity updateSyncStatus(String userId, String providerId, String syncStatus,
			String errorMessage) {
		// Get existing data
		ProviderDataEntity existing = readRepository.getProviderData(userId, providerId);
		if (existing == null) {
