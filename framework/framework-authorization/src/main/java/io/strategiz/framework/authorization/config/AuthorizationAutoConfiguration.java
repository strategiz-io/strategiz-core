 ...
 *
 * <ul>
 *   <li>Creates {@link PasetoTokenValidator} for ALL token validation (single source of truth)
 ...
 * </ul>
 *
 * <p>Token keys are loaded from Vault by {@link PasetoTokenValidator} at startup.
 *
 * <p>To use this framework, add the following to your application.properties:
 *
 * <pre>
...
@ConditionalOnProperty(
    prefix = "strategiz.authorization",
    name = "enabled",
    havingValue = "true",
    matchIfMissing = true)
@ComponentScan(
...
public class AuthorizationAutoConfiguration implements WebMvcConfigurer {
  ...
  public FilterRegistrationBean<PasetoAuthenticationFilter> pasetoAuthenticationFilter(
    ...
    FilterRegistrationBean<PasetoAuthenticationFilter> registration =
    ...
    log.info(
        "PasetoAuthenticationFilter registered with PasetoTokenValidator, skip-paths: {}",
