 ...
 *
 * Represents email-based OTP authentication for a user account. This stores the email
 * address and email OTP configuration.
 */
public class EmailOtpAuthenticationMethod extends AuthenticationMethod {
	...
	public String toString() {
		return "EmailOtpAuthenticationMethod{" + "id='" + getId() + '\'' + ", email='" + maskEmail(email) + '\''
				+ ", verified=" + verified + ", enabled=" + isEnabled() + ", lastOtpSentAt=" + lastOtpSentAt
