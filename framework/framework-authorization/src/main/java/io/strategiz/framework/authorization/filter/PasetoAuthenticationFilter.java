 ...
 *
 * <p>This filter delegates ALL token validation to {@link PasetoTokenValidator}, which is
 * the single source of truth for token validation in the system.</p>
 */
public class PasetoAuthenticationFilter implements Filter {
    ...
    public PasetoAuthenticationFilter(PasetoTokenValidator tokenValidator,
