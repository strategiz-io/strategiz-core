...
public class FmpFundamentalsConverter {
	...
	private void mapFmpData(FundamentalsEntity entity, FmpFundamentals fmp) {
		...
		// Cash Flow
		entity.setOperatingCashFlow(fmp.getOperatingCashFlow());
		entity.setCapitalExpenditure(fmp.getCapitalExpenditure());
		entity.setFreeCashFlow(fmp.getFreeCashFlow());
	...
	private String parsePeriodType(String period) {
		...
		// FMP uses same period codes as our constants
		switch (period.toUpperCase()) {
			case "Q1":
				return PeriodType.Q1;
			case "Q2":
				return PeriodType.Q2;
			case "Q3":
				return PeriodType.Q3;
			case "Q4":
				return PeriodType.Q4;
			case "FY":
