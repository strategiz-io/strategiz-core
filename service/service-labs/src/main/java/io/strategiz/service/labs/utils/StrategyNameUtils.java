...
/**
 * Utility class for strategy name operations Handles name normalization for
 * case-insensitive uniqueness checks
 */
public class StrategyNameUtils {

	/**
	 * Normalize strategy name for case-insensitive uniqueness checks Rules: - Convert to
	 * lowercase - Trim leading/trailing whitespace - Collapse multiple consecutive spaces
	 * to single space - Preserve Unicode characters (no slugification)
	 *
	 * Examples: " My STRATEGY " → "my strategy" "MACD Cross" → "macd cross" "Стратегия
	 * RSI" → "стратегия rsi"
