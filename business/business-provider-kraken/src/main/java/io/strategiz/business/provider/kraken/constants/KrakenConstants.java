...
public final class KrakenConstants {
	...
	public static final Map<String, String> ASSET_MAPPING = Map.ofEntries(Map.entry("XXBT", "BTC"), // Bitcoin
	...
	// Cash/Fiat assets
	public static final Set<String> CASH_ASSETS = Set.of("ZUSD", "USD", "ZEUR", "EUR", "ZGBP", "GBP", "ZCAD", "CAD",
