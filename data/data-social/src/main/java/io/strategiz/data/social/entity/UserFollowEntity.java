 ...
 *
 * Collection: user_follows (top-level)
 * Document ID: compound key {followerId}_{followingId}
 *
 * This is a one-way follow (like Twitter), not mutual friendship.
 * - followerId: the user who is doing the following
...
public class UserFollowEntity extends BaseEntity {
    ...
    /**
     * Generates compound document ID from follower and following IDs.
     * Format: {followerId}_{followingId}
     */
