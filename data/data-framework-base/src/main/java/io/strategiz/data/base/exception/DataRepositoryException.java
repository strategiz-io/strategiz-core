...
/**
 * Exception class for all data repository operations. Extends StrategizException for
 * integration with the global exception handling framework.
 *
 * <p>
 * Usage: throw new DataRepositoryException(DataRepositoryErrorDetails.ENTITY_NOT_FOUND,
 * "UserEntity", userId);
 */
public class DataRepositoryException extends StrategizException {
	 ...
	 * @param errorDetails The error details enum value
	 * @param moduleName Custom module name (e.g., "user-repository",
	 * "provider-repository")
	 * @param args Optional arguments for message formatting
	 */
