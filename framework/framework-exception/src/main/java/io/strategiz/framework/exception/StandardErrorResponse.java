 ...
 *
 * <p>This is the ONLY error response format allowed across the entire application. No additions,.
 * no. modifications, no domain-specific extensions permitted.
 *
 * <p>Contains exactly 4 fields - no more, no less.
 */
...
public class StandardErrorResponse {
  ...
  /** Technical details for developers (e.g., "Facebook OAuth returned error: invalid_grant"). */
  private final String developerMessage;

  /** URL to error documentation (e.g., "https://docs.strategiz.io/errors/authentication"). */
  private final String moreInfo;

  /** Create a standard error response with all required fields. */
  public StandardErrorResponse(
      String code, String message, String developerMessage, String moreInfo) {
    this.code = code;
   ...
   */
  public static StandardErrorResponse of(
      String code, String message, String developerMessage, String moreInfo) {
