...
/**
 * Comprehensive historical insights for a symbol, generated by analyzing years of market
 * data. This class aggregates volatility, indicator effectiveness, market
 * characteristics, and risk insights to help generate data-driven trading strategies
 * using Historical Market Insights (Autonomous AI mode).
 */
public class SymbolInsights {
	...
	private double optimalRsiOversold; // RSI value that captures 80% of historical
										// troughs

	private double optimalRsiOverbought; // RSI value that captures 80% of historical
											// peaks

	private double optimalPctDropForEntry; // % drop from high that captures 80% of
											// troughs
	...
	private String currentRegime; // STRONG_UPTREND, UPTREND, RANGING_VOLATILE,
									// RANGING_CALM, DOWNTREND, STRONG_DOWNTREND
	...
	private double kellyCriterion; // Optimal position size based on historical win/loss
									// ratio

	private double volatilityAdjustedSize; // Position size adjusted for current
											// volatility
	...
	/**
	 * Formats the insights into a human-readable summary suitable for AI prompt
	 * enhancement. This method is called by the AIStrategyService to inject historical
