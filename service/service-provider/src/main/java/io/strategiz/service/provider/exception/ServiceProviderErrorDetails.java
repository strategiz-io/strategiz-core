 ...
 *
 * Each error has a code, HTTP status, and message key for internationalization. Messages
 * are resolved from service-provider-errors.properties file.
 */
public enum ServiceProviderErrorDetails implements ErrorDetails {
	...
	INVALID_OAUTH_STATE(HttpStatus.BAD_REQUEST, "invalid-oauth-state"), // Alias for
																		// consistency
