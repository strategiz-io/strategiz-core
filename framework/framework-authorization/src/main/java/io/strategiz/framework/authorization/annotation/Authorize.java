 ...
 *
 * <p>This provides Layer 2 authorization - relationship-based access control. It checks if the
 * authenticated user has a specific relation to a resource.
 *
 * <p>The resourceId supports SpEL expressions to extract values from method parameters:
 *
 * <ul>
