 ...
 */
@Component
public class PytestResultParser implements TestResultParser {
    ...
    private static final Pattern ERROR_PATTERN = Pattern.compile("(\\d+)\\s+error");
    ...
    public List<TestResultEntity> parseResults(String output, String runId) {
        ...
        int errors = extractCount(output, ERROR_PATTERN);
