 ...
 *
 * Key rules: - Users cannot subscribe to their own strategies - Only published strategies
 * can be subscribed to - Pricing is determined by the strategy's pricing configuration
 */
@Service
public class StrategySubscriptionService extends BaseService {
	...
	@Autowired
	public StrategySubscriptionService(StrategySubscriptionRepository subscriptionRepository,
			ReadStrategyRepository readStrategyRepo, UpdateStrategyRepository updateStrategyRepo) {
	...
	public StrategySubscriptionEntity subscribe(String strategyId, String userId) {
		...
		Optional<StrategySubscriptionEntity> existing = subscriptionRepository.findByUserAndStrategy(userId,
				strategyId);
		...
		// Create subscription
		StrategySubscriptionEntity subscription = new StrategySubscriptionEntity(strategyId, userId,
				strategy.getOwnerId(), pricingType);
	 ...
	 */
	public List<StrategySubscriptionEntity> getStrategySubscribers(String strategyId, String requestingUserId,
			int limit) {
