...
/**
 * Repository for TestRunEntity Handles test execution runs
 */
public interface TestRunRepository {
	 ...
	 */
	List<TestRunEntity> findByHierarchy(TestExecutionLevel level, String appId, String moduleId, String suiteId,
			String testId);
	 ...
	 */
	TestRunEntity findLatestCiRun(TestExecutionLevel level, String appId, String moduleId, String suiteId);
