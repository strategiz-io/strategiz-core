 ...
 * Following the Synapse client framework pattern for imperative programming
 */
@Configuration
public class ClientBinanceUSConfig {
    ...
    /**
     * Creates the BinanceUSClient instance using the base client framework
     * This leverages the BaseHttpClient and ExchangeApiClient from client-base
     * With Spring property injection for credentials and URL
     * 
