...
public class PasskeyDebugController extends BaseController {
	...
	public ResponseEntity<Map<String, Object>> listAllChallenges() {
		...
		return createCleanResponse(
				Map.of("message", "Check server logs for challenge details", "timestamp", System.currentTimeMillis()));
	}
	...
	public ResponseEntity<Map<String, Object>> searchChallenge(@RequestParam String partial) {
		...
		return createCleanResponse(Map.of("message", "Check server logs for search results", "searched", partial,
	...
	public ResponseEntity<Map<String, Object>> createTestChallenge(@RequestParam String userId,
		...
		return createCleanResponse(Map.of("challengeId", challenge.getId(), "challenge", challenge.getChallenge(),
				"userId", challenge.getUserId(), "type", challenge.getChallengeType(), "expiresAt",
