...
/**
 * Represents a top-level application in the test hierarchy
 * Examples: "Web App", "Console App", "Auth App", "Backend API", "Python Microservice"
 * Stored in: tests/apps/{appId}
 */
@Entity
