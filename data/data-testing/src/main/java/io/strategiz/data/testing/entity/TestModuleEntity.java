...
/**
 * Represents a module within an application Examples: - Frontend: "E2E Tests", "Unit
 * Tests", "Integration Tests" - Backend: "service-auth", "service-labs",
 * "service-portfolio" - Python: "test_executor", "test_grpc_integration" Stored in:
 * tests/apps/{appId}/modules/{moduleId}
 */
@Entity
