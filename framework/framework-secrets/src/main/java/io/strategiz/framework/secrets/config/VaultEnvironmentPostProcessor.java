...
/**
 * Environment post-processor that loads OAuth credentials from Vault
 * early in the Spring Boot startup process, before beans are created.
 * This ensures @Value annotations work correctly.
 */
public class VaultEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        ...
        try {
            ...
            log.error("Failed to load OAuth credentials from Vault. Application will start but OAuth features may not work.", e);
        }
    }
