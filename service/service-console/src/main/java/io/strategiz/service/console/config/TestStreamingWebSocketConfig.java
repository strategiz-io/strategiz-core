...
/**
 * WebSocket configuration for real-time test execution log streaming
 * Enables streaming of test output to connected clients via WebSocket
 */
@Configuration
@EnableWebSocket
