...
public class DataRepositoryException extends StrategizException {
   ...
   */
  public DataRepositoryException(DataRepositoryErrorDetails errorDetails, Throwable cause,
      Object... args) {
   ...
   * @param args Optional arguments for message formatting
   */
  public DataRepositoryException(DataRepositoryErrorDetails errorDetails, String moduleName,
      Object... args) {
