...
public final class WebullConstants {
	...
	public static final Set<String> SUPPORTED_INSTRUMENT_TYPES = Set.of("STOCK", "ETF", "OPTION");

	// Supported markets
	public static final Set<String> SUPPORTED_MARKETS = Set.of("US" // Currently only US
																	// stocks/ETFs
	);
