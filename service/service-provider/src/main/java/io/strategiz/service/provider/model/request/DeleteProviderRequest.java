...
/**
 * Request model for deleting/disconnecting provider connections.
 * Used for safely removing provider integrations with optional cleanup.
 */
public class DeleteProviderRequest {
    ...
    private boolean emergencyDisconnect = false; // Emergency disconnect (skip provider API calls)
    ...
    public String toString() {
        return "DeleteProviderRequest{" +
                ...
                ", emergencyDisconnect=" + emergencyDisconnect +
                ", reason='" + reason + '\'' +
                '}';
    }
} 