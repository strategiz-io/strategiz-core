...
public record SmsOtpSendRequest(
		...
		@Pattern(regexp = "^[A-Z]{2}$",
				message = "Country code must be a valid ISO 3166-1 alpha-2 code") String countryCode) {
	/**
	...
	/**
	 * Simple country code detection based on phone number prefix This is a basic
	 * implementation - in production you'd use a proper phone number library
	 * @param phoneNumber The phone number in E.164 format
