 ...
 *
 * Firestore transactions use a callback model where all operations must happen inside the
 * transaction callback. This template provides a clean way to execute transactional
...
public class FirestoreTransactionTemplate {
	...
	/**
	 * Execute operations within a Firestore transaction. All operations inside the
	 * callback are atomic - either all succeed or all fail.
