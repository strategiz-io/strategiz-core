...
/**
 * Controller for handling Google OAuth sign-in flow Specifically for existing users
...
public class GoogleOAuthSignInController extends BaseController {
	...
	public ResponseEntity<Map<String, String>> getAuthorizationUrl(
		...
		Map<String, String> authInfo = googleOAuthService.getAuthorizationUrl(false, redirectAfterAuth); // isSignup
																											// =
																											// false
	...
	public ResponseEntity<Map<String, Object>> handleCallbackJson(@RequestBody Map<String, String> callbackRequest,
		...
		if (fraudDetectionService != null) {
			fraudDetectionService.verifyLogin(recaptchaToken, "google-oauth");
		}
		...
		try {
			...
			Map<String, Object> errorResponse = Map.of("success", false, "error", e.getMessage(), "message",
					"Google OAuth sign-in callback failed");
