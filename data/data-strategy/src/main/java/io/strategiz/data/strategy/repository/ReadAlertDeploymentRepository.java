...
/**
 * Repository interface for reading strategy alert entities Following Single
 * Responsibility Principle - focused only on read operations
 */
public interface ReadAlertDeploymentRepository {
	...
	/**
	 * Find all active alerts that are due for evaluation based on their evaluation
	 * frequency. This is a more efficient approach that lets the database filter by last
	 * checked time.
