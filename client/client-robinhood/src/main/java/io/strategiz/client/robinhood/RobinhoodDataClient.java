...
/**
 * Client for fetching data from Robinhood API.
 * Handles portfolio, positions, accounts, and quote data.
 *
...
public class RobinhoodDataClient {
    ...
    public Map<String, Object> getInstrument(String accessToken, String instrumentUrl) {
        return makeAuthenticatedRequest(instrumentUrl, accessToken, new ParameterizedTypeReference<Map<String, Object>>() {});
    }
     ...
     */
    private <T> T makeAuthenticatedRequest(String url, String accessToken,
                                           ParameterizedTypeReference<T> responseType) {
        try {
            if (accessToken == null || accessToken.trim().isEmpty()) {
                throw new StrategizException(RobinhoodErrors.ROBINHOOD_INVALID_TOKEN,
