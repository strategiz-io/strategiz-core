...
/**
 * Base response model for AlphaVantage API responses. Simple POJO that follows the
 * pattern used in other client modules.
 */
public class AlphaVantageResponse implements Serializable {
	...
	public String toString() {
		return "AlphaVantageResponse{" + "success=" + success + ", message='" + message + '\'' + ", timestamp="
				+ timestamp + '}';
	}
