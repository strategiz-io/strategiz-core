package io.strategiz.data.fundamentals.timescale.entity;
...
/**
 * JPA entity for storing company fundamentals in TimescaleDB.
 * Maps to the 'company_fundamentals' hypertable.
 *
 * Stores comprehensive financial metrics including:
 * - Income statement data (revenue, EBITDA, EPS, net income)
 * - Balance sheet data (assets, liabilities, equity, debt)
 * - Financial ratios (P/E, P/B, P/S, margins, ROE, ROA)
 ...
 *
 * @see io.strategiz.data.fundamentals.timescale.repository.FundamentalsTimescaleRepository
 */
@Entity
@Table(name = "company_fundamentals",
    indexes = {
        @Index(name = "idx_fundamentals_symbol",
               columnList = "symbol, fiscal_period DESC"),
        @Index(name = "idx_fundamentals_period_type",
               columnList = "period_type, fiscal_period DESC"),
        @Index(name = "idx_fundamentals_pe",
               columnList = "price_to_earnings"),
        @Index(name = "idx_fundamentals_dividend_yield",
               columnList = "dividend_yield")
    }
)
public class FundamentalsTimescaleEntity {
     ...
     */
    public FundamentalsTimescaleEntity() {
        this.currency = "USD";
     ...
     */
    public FundamentalsTimescaleEntity(String symbol, LocalDate fiscalPeriod, String periodType) {
        this();
        this.symbol = symbol;
    ...
    /**
     * Generate unique ID from symbol, fiscal period, and period type.
     * Format: {symbol}_{YYYY-MM-DD}_{periodType}
     */
    ...
    public boolean equals(Object o) {
        ...
        FundamentalsTimescaleEntity that = (FundamentalsTimescaleEntity) o;
    ...
    public String toString() {
        return String.format(
            "FundamentalsTimescaleEntity[%s %s %s: EPS=%.2f, PE=%.2f, Revenue=%.0f, MarketCap=%.0f]",
            symbol, fiscalPeriod, periodType,
            epsDiluted != null ? epsDiluted : BigDecimal.ZERO,
            priceToEarnings != null ? priceToEarnings : BigDecimal.ZERO,
            revenue != null ? revenue : BigDecimal.ZERO,
            marketCap != null ? marketCap : BigDecimal.ZERO
        );
    }
}
