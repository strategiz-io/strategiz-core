...
/**
 * Application context initializer that loads OAuth credentials from Vault
 * very early in the Spring Boot startup process, before beans are created.
 */
        ...
        try {
            ...
            if (response != null && response.getData() != null) {
                ...
                if (data != null) {
                    ...
                    addPropertyIfNotNull(properties, "oauth.providers.facebook.client-secret", data.get("client-secret"));
