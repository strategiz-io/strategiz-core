 ...
 * - Adding standard rate limiting headers to HTTP responses
 * - Following HTTP conventions (RFC 7231 for Retry-After header)
 * 
 * Note: Error response creation should be handled by throwing appropriate 
 * exceptions that will be converted by GlobalExceptionHandler
 */
public class RateLimitUtils {
     ...
     */
    public static void addRateLimitExceededHeaders(HttpServletResponse response, 
     ...
     */
    public static java.util.Map<String, Object> createRateLimitContext(int retryAfterSeconds, 
                                                                       Integer limit, 
                                                                       String window) {
