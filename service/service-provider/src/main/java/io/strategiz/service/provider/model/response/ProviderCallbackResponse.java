...
/**
 * Response model for provider OAuth callback processing. Contains the result of OAuth
...
public class ProviderCallbackResponse {
	...
	public String toString() {
		return "ProviderCallbackResponse{" + "providerId='" + providerId + '\'' + ", providerName='" + providerName
				+ '\'' + ", status='" + status + '\'' + ", message='" + message + '\'' + ", operationSuccess="
				+ operationSuccess + ", connectedAt=" + connectedAt + '}';
	}
