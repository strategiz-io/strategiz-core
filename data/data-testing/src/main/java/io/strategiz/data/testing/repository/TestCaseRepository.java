...
/**
 * Repository for TestCaseEntity Handles individual test cases within suites
 */
public interface TestCaseRepository {
	 ...
	 * @return Test case entity if found
	 */
	TestCaseEntity findByAppIdAndModuleIdAndSuiteIdAndMethodName(String appId, String moduleId, String suiteId,
			String methodName);
