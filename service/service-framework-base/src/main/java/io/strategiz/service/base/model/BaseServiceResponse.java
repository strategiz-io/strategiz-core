 ...
 *
 * Note: - Headers are handled by StandardHeadersInterceptor - Errors are handled by
 * GlobalExceptionHandler with StandardErrorResponse - Response models should contain only
