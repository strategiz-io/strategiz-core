...
/**
 * Configuration for data-marketdata module. Follows the standard naming convention:
 * Data[Module]Config
 */
@Configuration
...
public class DataMarketDataConfig {
	...
	/**
	 * Provide no-op MarketDataRepository when neither ClickHouse nor TimescaleDB is
	 * enabled. This bean will only be created if no other MarketDataRepository bean
	 * exists.
	 */
	@Bean
	...
	/**
	 * Configure MessageSource to load data marketdata error messages NOTE: Commented out
