...
public class AssetAllocationData {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(allocations, that.allocations) && Objects.equals(totalValue, that.totalValue);
	}
	...
	public String toString() {
		return "AssetAllocationData{" + "allocations=" + allocations + ", totalValue=" + totalValue + '}';
	}
