...
/**
 * Configuration adapter that bridges service-specific SMS OTP configuration
 * to the client interface required by the Firebase SMS client.
 * 
 * This adapter follows the Adapter pattern to decouple the client module
 * from service-specific configuration details.
 */
@Component
