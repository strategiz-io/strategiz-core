...
/**
 * Repository interface for updating strategy entities Following Single Responsibility
 * Principle - focused only on update operations
 */
public interface UpdateStrategyRepository {
	...
	/**
	 * Update strategy deployment status when deploying as alert or bot Sets status to
	 * "deployed", deploymentType, deploymentId, and deployedAt
	 */
