...
public class PortfolioSummaryResponse {
    ...
    public ArrayList<?> getAssets() { return assets; }
    public void setAssets(ArrayList<?> assets) { this.assets = assets; }
    ...
    public HashMap<String, ?> getExchanges() { return exchanges; }
    public void setExchanges(HashMap<String, ?> exchanges) { this.exchanges = exchanges; }
