 ...
 *
 * Represents SMS-based OTP authentication for a user account. This stores the phone
 * number and SMS OTP configuration.
 */
public class SmsOtpAuthenticationMethod extends AuthenticationMethod {
	...
	public String toString() {
		return "SmsOtpAuthenticationMethod{" + "id='" + getId() + '\'' + ", phoneNumber='"
				+ maskPhoneNumber(phoneNumber) + '\'' + ", countryCode='" + countryCode + '\'' + ", verified="
				+ verified + ", enabled=" + isEnabled() + ", lastOtpSentAt=" + lastOtpSentAt + ", dailySmsCount="
				+ dailySmsCount + '}';
	}
