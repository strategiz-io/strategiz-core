...
/**
 * Configuration for data-strategy module. Follows the standard naming convention:
 * Data[Module]Config
 */
@Configuration
...
public class DataStrategyConfig {
	...
	/**
	 * Configure MessageSource to load data strategy error messages NOTE: Commented out -
