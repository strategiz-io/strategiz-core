...
/**
 * Controller for updating provider connections and data. Handles HTTP requests for OAuth
...
public class UpdateProviderController extends ProviderBaseController {
	...
	public ResponseEntity<UpdateProviderResponse> updateProvider(@PathVariable String providerId,
			@Valid @RequestBody UpdateProviderRequest request, Principal principal) {
