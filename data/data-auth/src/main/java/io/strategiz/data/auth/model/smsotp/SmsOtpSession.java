 ...
 *
 * This represents a temporary SMS OTP session with the actual OTP code, expiration, and
 * verification tracking. This is separate from the SmsOtpAuthenticationMethod which
 * stores the phone number registration.
 */
public class SmsOtpSession {
	...
	public SmsOtpSession(String sessionId, String phoneNumber, String otpCode, String ipAddress, String countryCode,
			int expiryMinutes) {
		this();
	...
	public String toString() {
		return "SmsOtpSession{" + "sessionId='" + sessionId + '\'' + ", phoneNumber='" + getMaskedPhoneNumber() + '\''
				+ ", countryCode='" + countryCode + '\'' + ", verified=" + verified + ", verificationAttempts="
				+ verificationAttempts + ", expiresAt=" + expiresAt + ", isExpired=" + isExpired() + '}';
	}
