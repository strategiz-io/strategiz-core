...
/**
 * Development implementation of EmailOTP authentication strategy. This implementation
 * logs OTP codes instead of sending actual emails, making it easier to test in
 * development environments. Active in any profile other than "prod".
 */
@Component
...
public class DevEmailOtpStrategy implements AuthMethodStrategy {
	...
	public Object setupAuthentication(UserEntity user) {
		...
		return Map.of("success", true, "message", "Email verification skipped in development", "mockCode", mockCode,
				"requiresVerification", true, "verificationType", "emailotp");
	}
