...
/**
 * Error codes for secrets framework operations. Implements ErrorDetails for integration with the
 * Strategiz exception framework.
 *
 * <p>Usage: throw new StrategizException(SecretsErrors.VAULT_CONNECTION_FAILED, MODULE_NAME);
 */
