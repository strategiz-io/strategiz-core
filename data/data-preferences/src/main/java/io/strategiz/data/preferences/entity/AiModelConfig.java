 ...
 *
 * <p>
 * This entity allows admin configuration of AI model costs and tier requirements without
 * code deploys. Changes take effect immediately.
 * </p>
 *
 * <p>
 * Firestore path: config/ai-models/{modelId}
 * </p>
 *
 * <p>
...
public class AiModelConfig extends BaseEntity {
	...
	/**
	 * Base STRAT cost per 1000 tokens. This is the relative cost weight compared to the
	 * baseline model.
	 */
	...
	/**
	 * Multiplier for cost adjustments (default 1.0). Can be used to quickly adjust
	 * pricing without changing base cost.
	 */
	...
	/**
	 * Minimum tier required to access this model. Values: explorer, strategist, quant
	 */
	 ...
	 *
	 * Tier Organization: - EXPLORER (Free): Only free/very cheap models via Vertex AI (no
	 * direct API costs) - STRATEGIST (Paid): Budget-friendly models from all providers -
	...
	public static List<AiModelConfig> createDefaults() {
		...
		// ============================================================
		models.add(createModel("gemini-2.5-flash", "Gemini 2.5 Flash", PROVIDER_GOOGLE, 1, TierConfig.TIER_EXPLORER,
				"fast", "Fastest Google model"));
		models.add(createModel("gemini-1.5-flash", "Gemini 1.5 Flash", PROVIDER_GOOGLE, 1, TierConfig.TIER_EXPLORER,
				"fast", "Fast and efficient"));
		models.add(createModel("llama-3.1-8b-instruct-maas", "Llama 3.1 8B", PROVIDER_META, 1, TierConfig.TIER_EXPLORER,
				"fast", "Fast open source model"));
		models.add(createModel("mistral-nemo", "Mistral Nemo", PROVIDER_MISTRAL, 1, TierConfig.TIER_EXPLORER, "fast",
				"Fast Mistral model"));
		models.add(createModel("grok-3-mini", "Grok 3 Mini", PROVIDER_XAI, 1, TierConfig.TIER_EXPLORER, "fast",
				"Free tier Grok model"));
		...
		// Google
		models.add(createModel("gemini-2.5-pro", "Gemini 2.5 Pro", PROVIDER_GOOGLE, 15, TierConfig.TIER_STRATEGIST,
				"balanced", "Most capable Google model"));
		models.add(createModel("gemini-1.5-pro", "Gemini 1.5 Pro", PROVIDER_GOOGLE, 15, TierConfig.TIER_STRATEGIST,
				"balanced", "Balanced performance"));

		// OpenAI
		models.add(createModel("gpt-4o-mini", "GPT-4o Mini", PROVIDER_OPENAI, 4, TierConfig.TIER_STRATEGIST, "fast",
				"Fast and affordable"));
		models.add(createModel("gpt-4o", "GPT-4o", PROVIDER_OPENAI, 25, TierConfig.TIER_STRATEGIST, "balanced",
				"Flagship multimodal model"));

		// Anthropic
		models.add(createModel("claude-3-haiku", "Claude 3 Haiku", PROVIDER_ANTHROPIC, 3, TierConfig.TIER_STRATEGIST,
				"fast", "Budget-friendly, fast"));
		models.add(createModel("claude-3-sonnet", "Claude 3 Sonnet", PROVIDER_ANTHROPIC, 25, TierConfig.TIER_STRATEGIST,
				"balanced", "Budget-friendly, balanced"));
		...
		// Mistral
		models.add(createModel("mistral-small", "Mistral Small", PROVIDER_MISTRAL, 2, TierConfig.TIER_STRATEGIST,
				"fast", "Efficient Mistral model"));
		models.add(createModel("mistral-large-2", "Mistral Large 2", PROVIDER_MISTRAL, 12, TierConfig.TIER_STRATEGIST,
				"balanced", "Capable Mistral model"));

		// Cohere
		models.add(createModel("command-r", "Command R", PROVIDER_COHERE, 2, TierConfig.TIER_STRATEGIST, "fast",
				"Fast Cohere model"));

		// xAI Grok
		models.add(createModel("grok-3", "Grok 3", PROVIDER_XAI, 25, TierConfig.TIER_STRATEGIST, "balanced",
		...
		// OpenAI
		models.add(createModel("gpt-4-turbo", "GPT-4 Turbo", PROVIDER_OPENAI, 60, TierConfig.TIER_QUANT, "balanced",
				"Fast GPT-4 variant"));
		models.add(createModel("o1-mini", "o1 Mini", PROVIDER_OPENAI, 30, TierConfig.TIER_QUANT, "powerful",
				"Reasoning model, affordable"));
		models.add(createModel("o1", "o1", PROVIDER_OPENAI, 150, TierConfig.TIER_QUANT, "powerful",
				"Advanced reasoning model"));

		// Anthropic
		models.add(createModel("claude-3-opus", "Claude 3 Opus", PROVIDER_ANTHROPIC, 125, TierConfig.TIER_QUANT,
				"powerful", "Previous flagship model"));
		models.add(createModel("claude-haiku-4-5", "Claude Haiku 4.5", PROVIDER_ANTHROPIC, 8, TierConfig.TIER_QUANT,
				"fast", "Latest fast model"));
		models.add(createModel("claude-sonnet-4-5", "Claude Sonnet 4.5", PROVIDER_ANTHROPIC, 25, TierConfig.TIER_QUANT,
				"balanced", "Best balanced model"));
		models.add(createModel("claude-opus-4-5", "Claude Opus 4.5", PROVIDER_ANTHROPIC, 90, TierConfig.TIER_QUANT,
				"powerful", "Most capable for complex tasks"));
		...
		// Cohere
		models.add(createModel("command-r-plus", "Command R+", PROVIDER_COHERE, 18, TierConfig.TIER_QUANT, "balanced",
				"Most capable Cohere"));

		// xAI Grok
		models.add(createModel("grok-4", "Grok 4", PROVIDER_XAI, 30, TierConfig.TIER_QUANT, "powerful",
				"Advanced reasoning & coding"));
		models.add(createModel("grok-4.1-fast", "Grok 4.1 Fast", PROVIDER_XAI, 30, TierConfig.TIER_QUANT, "powerful",
				"Best for tool-calling, 2M context"));
