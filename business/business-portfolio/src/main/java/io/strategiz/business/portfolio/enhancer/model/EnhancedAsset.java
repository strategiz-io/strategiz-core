...
/**
 * Represents an enhanced asset with full metadata, pricing, and user-friendly information.
 */
        ...
        public EnhancedAsset build() {
            ...
            if (asset.costBasis != null && asset.value != null) {
                ...
                if (asset.costBasis.compareTo(BigDecimal.ZERO) > 0) {
                    asset.profitLossPercent = asset.profitLoss
                        .divide(asset.costBasis, 4, BigDecimal.ROUND_HALF_UP)
