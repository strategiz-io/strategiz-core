 ...
 *
 * This configuration automatically sets up: - Structured JSON logging - Request
 * correlation and tracing - Performance monitoring - Logging context management
 *
 * The configuration is automatically enabled when the framework-logging dependency is
