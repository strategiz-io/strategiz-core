 ...
 *
 * Vault path: secret/strategiz/github-app Required fields: - app-id: GitHub App ID
 * (numeric string, e.g. "2564716") - private-key: GitHub App private key in PEM format
 * (the full content of the .pem file)
 */
@Configuration
		...
		try {
			...
			if (privateKey != null && !privateKey.isEmpty()) {
				...
				if (privateKey != null && !privateKey.isEmpty()) {
					...
					log.warn(
							"GitHub App private key not found in environment or Vault - Automation & Agents will be disabled");
				}
			}
			...
			if (installationId != null && !installationId.isEmpty()) {
				...
				if (installationId != null && !installationId.isEmpty()) {
					...
					log.warn(
							"GitHub App installation ID not found in environment or Vault - Automation & Agents will be disabled");
				}
			}
