...
public class ReadStrategyController extends BaseController {
	...
	public ResponseEntity<List<StrategyResponse>> getUserStrategies(@RequestParam(required = false) String status,
			@RequestParam(required = false) String language, @AuthUser AuthenticatedUser user) {

		String userId = user.getUserId();
		logger.info("Fetching strategies for user: {} with status: {} and language: {}", userId, status, language);
	...
	public ResponseEntity<StrategyResponse> getStrategyById(@PathVariable String strategyId,
	...
	public ResponseEntity<List<StrategyResponse>> getPublicStrategies(@RequestParam(required = false) String language,
