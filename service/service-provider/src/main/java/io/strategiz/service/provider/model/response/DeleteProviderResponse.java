...
/**
 * Response model for deleting/disconnecting provider connections. Contains results of
 * cleanup operations and disconnection status.
 */
public class DeleteProviderResponse {
	...
	public boolean isCompleteCleanup() {
		return Boolean.TRUE.equals(tokensRevoked) && Boolean.TRUE.equals(dataCleared)
				&& Boolean.TRUE.equals(configRemoved) && Boolean.TRUE.equals(accountDisconnected);
	}
	...
	public String toString() {
		return "DeleteProviderResponse{" + "providerId='" + providerId + '\'' + ", providerName='" + providerName + '\''
				+ ", status='" + status + '\'' + ", operationSuccess=" + operationSuccess + ", isCompleteCleanup="
				+ isCompleteCleanup() + ", hasBackup=" + hasBackup() + ", hasPreservedData=" + hasPreservedData()
				+ ", hasWarnings=" + hasWarnings() + ", hasErrors=" + hasErrors() + ", hasPendingTasks="
				+ hasPendingTasks() + ", responseTimestamp=" + responseTimestamp + '}';
	}
