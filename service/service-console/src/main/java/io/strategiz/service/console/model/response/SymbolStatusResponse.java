...
/**
 * Response model for paginated symbol status list. Used for the symbol data grid in the
 * admin console.
 */
public class SymbolStatusResponse {
	...
	public SymbolStatusResponse(List<SymbolStatus> symbols, Integer page, Integer pageSize, Long totalCount,
			Integer totalPages, StatusSummary summary) {
	...
	public static class SymbolStatus {
		...
		private Map<String, TimeframeStatus> timeframeStatus; // Key: timeframe (e.g.,
																// "1D")
		...
		public Map<String, TimeframeStatus> getTimeframeStatus() {
			return timeframeStatus;
		}

		public void setTimeframeStatus(Map<String, TimeframeStatus> timeframeStatus) {
