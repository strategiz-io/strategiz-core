...
/**
 * Platform configuration stored at config/platform/current.
 * Contains configurable settings for the Strategiz platform.
 *
 * <p>This entity stores platform-wide settings that can be adjusted without code changes,
 * including platform fees, STRAT token rates, and other configurable values.</p>
 *
 * <p>Firestore path: config/platform/current</p>
 *
...
public class PlatformConfig extends BaseEntity {
    ...
    /**
     * Platform fee percentage as a decimal (e.g., 0.15 for 15%).
     * Applied to owner subscription revenue and tips.
     */
    ...
    /**
     * Number of STRAT tokens per 1 USD.
     * Default: 100 (so $1 = 100 STRAT)
     */
    ...
    /**
     * Minimum purchase amount in USD cents.
     * Default: 500 ($5.00)
     */
    ...
    /**
     * Minimum tip amount in STRAT tokens.
     * Default: 10
     */
    ...
    /**
     * Minimum withdrawal amount in STRAT tokens.
     * Default: 1000
     */
    ...
    /**
     * Default owner subscription price in USD.
     * Used as suggestion when owner enables subscriptions.
     * Default: 50.00
     */
    ...
    /**
     * Calculate the owner's share percentage (1 - platformFeePercent).
     * E.g., if platformFeePercent is 0.15, owner share is 0.85 (85%).
     */
    ...
    public BigDecimal stratToUsd(long stratAmount) {
        return BigDecimal.valueOf(stratAmount).divide(BigDecimal.valueOf(stratTokensPerUsd), 2, java.math.RoundingMode.HALF_UP);
    }
    ...
    public String toString() {
        return "PlatformConfig{" +
                ...
                ", stratTokensPerUsd=" + stratTokensPerUsd +
                ", minimumPurchaseCents=" + minimumPurchaseCents +
                ", minimumTipStrat=" + minimumTipStrat +
                ", defaultOwnerPrice=" + defaultOwnerPrice +
                '}';
    }
