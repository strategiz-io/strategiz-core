...
/**
 * Maps Kraken-specific symbols to standard symbols and provides metadata. Handles
 * Kraken's unique naming conventions and staking suffixes.
 */
@Component
public class KrakenSymbolMapper {
	...
	static {
		...
		KRAKEN_TO_STANDARD.put("INJ", "INJ"); // Injective (direct mapping already exists
												// above)
	...
	private boolean isFiatSymbol(String symbol) {
		return symbol.equals("USD") || symbol.equals("EUR") || symbol.equals("GBP") || symbol.equals("CAD")
				|| symbol.equals("JPY") || symbol.equals("AUD") || symbol.equals("CHF") || symbol.equals("CNY")
				|| symbol.equals("KRW");
	}
