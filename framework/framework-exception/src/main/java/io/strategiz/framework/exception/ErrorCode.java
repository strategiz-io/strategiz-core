...
public enum ErrorCode {
	...
	// 4xx Client Errors
	VALIDATION_ERROR(400, "Validation failed"), AUTHENTICATION_ERROR(401, "Authentication failed"),
	AUTHORIZATION_ERROR(403, "Access denied"), RESOURCE_NOT_FOUND(404, "Resource not found"),
	METHOD_NOT_ALLOWED(405, "Method not allowed"), CONFLICT(409, "Resource conflict"),
	PRECONDITION_FAILED(412, "Precondition failed"), TOO_MANY_REQUESTS(429, "Too many requests"),
	...
	// Custom error codes
	BUSINESS_RULE_VIOLATION(400, "Business rule violation"), DATA_INTEGRITY_ERROR(400, "Data integrity error"),
