...
public enum SubscriptionTier {
	...
	SCOUT("scout", "Scout", 0,
			List.of("gemini-2.5-flash", "gemini-1.5-flash", "gpt-4o-mini", "llama-3.1-8b-instruct-maas", "mistral-nemo"),
			25, // AI chat messages/day
			"Free tier - Explore the markets"),

	TRADER("trader", "Trader", 1900, // $19.00 in cents
			List.of("gemini-2.5-flash", "gemini-1.5-flash", "gemini-1.5-pro", "gpt-4o-mini", "claude-haiku-4-5", "gpt-4o",
	...
	STRATEGIST("strategist", "Strategist", 4900, // $49.00 in cents
			List.of("gemini-2.5-flash", "gemini-2.5-pro", "gemini-1.5-flash", "gemini-1.5-pro", "gpt-4o-mini", "claude-haiku-4-5", "gpt-4o", "claude-opus-4-5",
