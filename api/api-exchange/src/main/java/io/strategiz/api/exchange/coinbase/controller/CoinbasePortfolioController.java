...
import io.strategiz.data.exchange.coinbase.model.Account;
import io.strategiz.data.exchange.coinbase.model.TickerPrice;
    ...
    public ResponseEntity<Map<String, Object>> getPortfolioData(@RequestParam String email) {
        ...
        try {
            ...
            try {
                ...
                io.strategiz.data.exchange.coinbase.model.Balance mockBalance = new io.strategiz.data.exchange.coinbase.model.Balance();
