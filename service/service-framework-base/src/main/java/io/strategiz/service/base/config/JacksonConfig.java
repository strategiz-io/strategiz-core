 ...
 *
 * Key configurations: - Excludes null values from JSON responses (reduces payload size) -
 * Configures proper date/time serialization - Ensures consistent JSON formatting across
 * all API responses
 *
...
public class JacksonConfig {
	 ...
	 *
	 * Configuration: - NON_EMPTY: Excludes null fields, empty strings, and empty
	 * collections from JSON output - JavaTimeModule: Proper Java 8 date/time support -
	...
	public ObjectMapper objectMapper(Jackson2ObjectMapperBuilder builder) {
		...
		// Register Java 8 date/time module for proper Instant, LocalDateTime, etc.
		// serialization
