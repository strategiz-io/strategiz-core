...
/**
 * Service for managing Binance US API credentials in Vault
 */
@Service
public class BinanceUSCredentialService {
    
    private static final Logger log = LoggerFactory.getLogger(BinanceUSCredentialService.class);
