...
/**
 * Thread-local holder for the security context. Provides static methods to access the
...
public final class SecurityContextHolder {
	...
	/**
	 * Clear the security context for the current thread. Should be called at the end of
	 * request processing.
	 */
	...
	public static AuthenticatedUser requireAuthenticatedUser() {
		return getAuthenticatedUser()
			.orElseThrow(() -> new StrategizException(AuthorizationErrorDetails.NOT_AUTHENTICATED, MODULE_NAME));
	}
