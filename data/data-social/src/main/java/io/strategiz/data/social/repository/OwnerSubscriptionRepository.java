 ...
 *
 * <p>Manages subscriptions where users subscribe to strategy OWNERS (not individual strategies).
 * Subscribers can deploy all of the owner's PUBLIC strategies.</p>
 *
 * <p>Note: This interface replaces the deprecated UserSubscriptionRepository.</p>
 *
