...
/**
 * Token-based session service that delegates to SessionAuthBusiness This maintains
 * compatibility with the existing PASETO token approach Will be deprecated in favor of
...
public class TokenSessionService extends BaseService {
	...
	public String createSession(String userId, String deviceId, String ipAddress) {
		...
		SessionAuthBusiness.AuthRequest authRequest = new SessionAuthBusiness.AuthRequest(userId, null, // Email
				...
				deviceId, deviceId, // Use as fingerprint
				ipAddress, "Token Session Service", false // demoMode
		);
	...
	public String createSession(String userId) {
		...
		SessionAuthBusiness.AuthRequest authRequest = new SessionAuthBusiness.AuthRequest(userId, null, // Email
				...
				null, // No fingerprint
				null, // No IP address
				"Token Session Service", false // demoMode
		);
