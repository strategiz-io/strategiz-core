...
/**
 * WebSocket handler for streaming test execution logs in real-time
 * Manages WebSocket connections and broadcasts log lines to connected clients
 */
@Component
public class TestStreamingHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) {
        ...
        log.info("WebSocket connected for runId: {}, sessionId: {}, total sessions: {}",
                runId, session.getId(), runIdToSessions.get(runId).size());
    }
    ...
    public void afterConnectionClosed(WebSocketSession session, CloseStatus status) {
        ...
        if (sessions != null) {
            ...
            log.info("WebSocket closed for runId: {}, sessionId: {}, status: {}, remaining sessions: {}",
                    runId, session.getId(), status, sessions.size());
