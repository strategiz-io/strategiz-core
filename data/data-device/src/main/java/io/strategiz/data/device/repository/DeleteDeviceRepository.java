...
/**
 * Repository interface exclusively for device deletion operations Single Responsibility:
 * Device removal/deletion
 */
public interface DeleteDeviceRepository {
	...
	/**
	 * Purge all anonymous devices WARNING: This deletes ALL anonymous devices
	 * @return Number of devices deleted
	 */
