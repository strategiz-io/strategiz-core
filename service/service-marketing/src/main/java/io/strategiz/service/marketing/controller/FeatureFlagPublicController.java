...
/**
 * Public endpoint for checking feature flags (no authentication required).
 * Only exposes specific flags needed by public pages.
 *
 * Endpoints:
 * - GET /v1/public/flags/pre-launch - Check if pre-launch mode is enabled
 */
@RestController
...
public class FeatureFlagPublicController extends BaseController {
     ...
     * Used by frontend to determine whether to show pre-launch or normal landing page.
     */
