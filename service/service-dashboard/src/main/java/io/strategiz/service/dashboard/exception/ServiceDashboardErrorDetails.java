 ...
 *
 * Each error maps to properties in service-dashboard-errors.properties file which
 * contains: - Error code - User-friendly message - Developer message template with
 * placeholders - Documentation path
 *
 * Usage: throw new StrategizException(ServiceDashboardErrorDetails.PORTFOLIO_NOT_FOUND,
 * "service-dashboard", portfolioId); throw new
 * StrategizException(ServiceDashboardErrorDetails.METRICS_CALCULATION_FAILED,
 * "service-dashboard", "ROI", "30D", "Division by zero");
 */
