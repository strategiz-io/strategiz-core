 ...
 * Messages are resolved from provider-errors.properties file.
 */
public enum ProviderErrorDetails implements ErrorDetails {
    ...
    ProviderErrorDetails(HttpStatus httpStatus, String messageKey) {
