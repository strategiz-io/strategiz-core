...
/**
 * Business component for fetching and caching market prices. Uses Yahoo Finance for
...
public class MarketPriceBusiness {
	...
	/**
	 * Fetch crypto price using static prices (Yahoo Finance integration to be implemented
	 * later)
	 */
	private BigDecimal fetchCryptoPrice(String symbol) {
		...
		Map<String, BigDecimal> staticPrices = Map.ofEntries(Map.entry("BTC", new BigDecimal("110851.07")), // Bitcoin
																											// -
																											// from
																											// screenshot
				...
				Map.entry("DOT", new BigDecimal("7.50")), Map.entry("MATIC", new BigDecimal("0.85")),
				Map.entry("POL", new BigDecimal("0.276")), // Polygon - from screenshot
				Map.entry("LINK", new BigDecimal("15")), Map.entry("UNI", new BigDecimal("6.50")),
				Map.entry("ATOM", new BigDecimal("8.20")), Map.entry("XRP", new BigDecimal("2.87")), // XRP
																										// -
																										// from
																										// screenshot
				Map.entry("XLM", new BigDecimal("0.12")), Map.entry("LTC", new BigDecimal("75")),
				...
				Map.entry("XMR", new BigDecimal("160")), Map.entry("ZEC", new BigDecimal("35")),
				Map.entry("ALGO", new BigDecimal("0.20")), Map.entry("FLOW", new BigDecimal("0.80")),
				Map.entry("NEAR", new BigDecimal("2.50")), Map.entry("FIL", new BigDecimal("4.50")),
				Map.entry("GRT", new BigDecimal("0.18")), Map.entry("OCEAN", new BigDecimal("0.65")),
				Map.entry("STORJ", new BigDecimal("0.55")), Map.entry("SAND", new BigDecimal("0.40")),
				Map.entry("MANA", new BigDecimal("0.55")), Map.entry("GALA", new BigDecimal("0.01625")), // Gala
																											// Games
																											// -
																											// from
																											// screenshot
				...
				Map.entry("RENDER", new BigDecimal("5.50")), Map.entry("BABY", new BigDecimal("0.0000001")),
	...
	/**
	 * Fetch crypto prices in batch using static prices (Yahoo Finance integration to be
	 * implemented later)
	 */
	...
	private BigDecimal fetchFiatRate(String symbol) {
		...
		Map<String, BigDecimal> rates = Map.of("EUR", new BigDecimal("1.10"), "GBP", new BigDecimal("1.25"), "JPY",
				new BigDecimal("0.0067"), "CAD", new BigDecimal("0.74"), "AUD", new BigDecimal("0.65"), "CHF",
				new BigDecimal("1.12"));
