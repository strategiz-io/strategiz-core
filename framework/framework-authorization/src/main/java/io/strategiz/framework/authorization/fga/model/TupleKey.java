...
/**
 * Represents an authorization tuple in the FGA model.
 * A tuple defines a relationship between a user and a resource.
 *
 * <p>Example: {@code TupleKey("user:123", "owner", "portfolio:456")}</p>
 * <p>Means: "user 123 is an owner of portfolio 456"</p>
 *
