...
# Provider OAuth Callback API Documentation
...
### 3.1 Sequence Diagram - OAuth Callback Flow (GET)
...
sequenceDiagram
    ...
    C-->>P: RedirectView → Frontend success page
    P-->>FE: Redirect user to success page
```

### 3.2 Sequence Diagram - OAuth Error Handling
...
sequenceDiagram
    ...
    C-->>P: RedirectView → Frontend error page
