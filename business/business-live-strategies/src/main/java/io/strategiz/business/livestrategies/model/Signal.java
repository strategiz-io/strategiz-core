...
/**
 * Represents a trading signal generated by strategy execution.
 * Contains the signal type (BUY/SELL/HOLD) and associated metadata.
 */
public class Signal {
	...
	public String toString() {
		return String.format("Signal[%s %s @ %.2f for deployment=%s, strategy=%s]",
				type, symbol, price, deploymentId, strategyId);
	}
