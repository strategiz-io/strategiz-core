...
/**
 * Entity for pending push authentication requests. Tracks the state of a push auth flow
...
public class PushAuthRequestEntity extends BaseEntity {
	...
	/**
	 * Purpose of this push auth request. e.g., "signin", "mfa", "recovery"
	 */
	...
	/**
	 * Challenge token that must be returned when approving. Prevents replay attacks.
	 */
	...
	/**
	 * IP address of the sign-in attempt. Shown to user in push notification.
	 */
	...
	/**
	 * User agent of the sign-in attempt. Shown to user in push notification.
	 */
	...
	/**
	 * Location derived from IP (city, country). Shown to user in push notification.
	 */
