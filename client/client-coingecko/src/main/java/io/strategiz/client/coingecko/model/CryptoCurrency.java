...
public class CryptoCurrency {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(id, that.id) && Objects.equals(symbol, that.symbol) && Objects.equals(name, that.name)
				&& Objects.equals(image, that.image) && Objects.equals(currentPrice, that.currentPrice)
				&& Objects.equals(priceChangePercentage24h, that.priceChangePercentage24h)
				&& Objects.equals(marketCap, that.marketCap) && Objects.equals(priceChange24h, that.priceChange24h)
				&& Objects.equals(totalVolume, that.totalVolume) && Objects.equals(lastUpdated, that.lastUpdated);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, symbol, name, image, currentPrice, priceChangePercentage24h, marketCap, priceChange24h,
				totalVolume, lastUpdated);
	}

	@Override
	public String toString() {
		return "CryptoCurrency{" + "id='" + id + '\'' + ", symbol='" + symbol + '\'' + ", name='" + name + '\''
				+ ", image='" + image + '\'' + ", currentPrice=" + currentPrice + ", priceChangePercentage24h="
				+ priceChangePercentage24h + ", marketCap=" + marketCap + ", priceChange24h=" + priceChange24h
				+ ", totalVolume=" + totalVolume + ", lastUpdated='" + lastUpdated + '\'' + '}';
	}
