...
public enum ActivityType {
    ...
    STRATEGY_PUBLISHED("Published a new strategy"),
    STRATEGY_UPDATED("Updated a strategy"),
    STRATEGY_ARCHIVED("Archived a strategy"),

    // Trading activities
    TRADE_EXECUTED("Executed a trade"),
    ALERT_TRIGGERED("Alert was triggered"),
    BOT_STARTED("Started a trading bot"),
    BOT_STOPPED("Stopped a trading bot"),

    // Social activities
    FOLLOWED_USER("Started following a user"),
    SUBSCRIBED_STRATEGY("Subscribed to a strategy"),

    // Account activities
    PROVIDER_CONNECTED("Connected a trading provider"),
