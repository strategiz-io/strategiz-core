...
public class MarketSentimentResponse {
	...
	public MarketSentimentResponse(FearGreedIndex fearGreedIndex, List<SentimentIndicator> indicators,
			Map<String, TrendingAsset> trendingAssets, LocalDateTime lastUpdated, SentimentIndicator overallSentiment,
			List<AssetSentiment> assetSentiments, MarketTrends marketTrends) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(fearGreedIndex, that.fearGreedIndex) && Objects.equals(indicators, that.indicators)
				&& Objects.equals(trendingAssets, that.trendingAssets) && Objects.equals(lastUpdated, that.lastUpdated)
	...
	@Override
	public int hashCode() {
		return Objects.hash(fearGreedIndex, indicators, trendingAssets, lastUpdated, overallSentiment, assetSentiments,
				marketTrends);
	}

	@Override
	public String toString() {
		return "MarketSentimentResponse{" + "fearGreedIndex=" + fearGreedIndex + ", indicators=" + indicators
				+ ", trendingAssets=" + trendingAssets + ", lastUpdated=" + lastUpdated + ", overallSentiment="
				+ overallSentiment + ", assetSentiments=" + assetSentiments + ", marketTrends=" + marketTrends + '}';
	}
	...
	public static class Builder {
		...
		public MarketSentimentResponse build() {
			return new MarketSentimentResponse(fearGreedIndex, indicators, trendingAssets, lastUpdated,
	...
	public static class FearGreedIndex {
		...
		public String toString() {
			return "FearGreedIndex{" + "value=" + value + ", classification='" + classification + '\''
					+ ", previousClose=" + previousClose + ", weekAgo=" + weekAgo + ", monthAgo=" + monthAgo + '}';
		}
	...
	public static class TrendingAsset {
		...
		public TrendingAsset(String id, String symbol, String name, BigDecimal price, BigDecimal changePercent24h,
				BigDecimal marketCap, BigDecimal volume24h, int rank) {
			this.id = id;
			this.symbol = symbol;
			this.name = name;
			this.price = price;
		...
		public boolean equals(Object o) {
			...
			return rank == that.rank && Objects.equals(id, that.id) && Objects.equals(symbol, that.symbol)
					&& Objects.equals(name, that.name) && Objects.equals(price, that.price)
					&& Objects.equals(changePercent24h, that.changePercent24h)
					&& Objects.equals(marketCap, that.marketCap) && Objects.equals(volume24h, that.volume24h);
		}
		...
		@Override
		public String toString() {
			return "TrendingAsset{" + "id='" + id + '\'' + ", symbol='" + symbol + '\'' + ", name='" + name + '\''
					+ ", price=" + price + ", changePercent24h=" + changePercent24h + ", marketCap=" + marketCap
					+ ", volume24h=" + volume24h + ", rank=" + rank + '}';
		}
	...
	public static class AssetSentiment {
		...
		public AssetSentiment(String assetId, String symbol, String name, String sentiment, BigDecimal sentimentScore,
				String color, List<String> signals, Map<String, BigDecimal> technicalIndicators,
		...
		public String toString() {
			return "AssetSentiment{" + "assetId='" + assetId + '\'' + ", symbol='" + symbol + '\'' + ", name='" + name
					+ '\'' + ", sentiment='" + sentiment + '\'' + ", sentimentScore=" + sentimentScore + ", color='"
					+ color + '\'' + ", signals=" + signals + ", technicalIndicators=" + technicalIndicators
	...
	public static class MarketTrends {
		...
		public int hashCode() {
			return Objects.hash(cryptoMarketCap, cryptoVolume24h, btcDominance, stockMarketCap, stockVolume24h,
					indexPerformance, sectorPerformance, fearGreedIndex, fearGreedCategory, uptrendPercentage,
					downtrendPercentage, neutralTrendPercentage);
		}

		@Override
		public String toString() {
			return "MarketTrends{" + "cryptoMarketCap=" + cryptoMarketCap + ", cryptoVolume24h=" + cryptoVolume24h
					+ ", btcDominance=" + btcDominance + ", stockMarketCap=" + stockMarketCap + ", stockVolume24h="
					+ stockVolume24h + ", indexPerformance=" + indexPerformance + ", sectorPerformance="
					+ sectorPerformance + ", fearGreedIndex=" + fearGreedIndex + ", fearGreedCategory='"
					+ fearGreedCategory + '\'' + ", uptrendPercentage=" + uptrendPercentage + ", downtrendPercentage="
					+ downtrendPercentage + ", neutralTrendPercentage=" + neutralTrendPercentage + '}';
		}
