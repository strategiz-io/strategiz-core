...
/**
 * Session entity for storing authentication sessions and tokens Combines token and
 * session data in a single collection Stored in the 'sessions' collection in Firestore
 */
@Collection("sessions")
