...
/**
 * Repository interface for deleting strategy alert history entities Following Single
 * Responsibility Principle - focused only on delete operations
 */
public interface DeleteAlertDeploymentHistoryRepository {
