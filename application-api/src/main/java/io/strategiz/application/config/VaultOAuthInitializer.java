...
public class VaultOAuthInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
	...
	private void loadProviderCredentials(VaultTemplate vaultTemplate, Map<String, Object> properties) {
		...
		// Load E*TRADE OAuth (OAuth 1.0a - uses consumer-key/secret instead of
		// client-id/secret)
	...
	/**
	 * Load E*TRADE OAuth 1.0a credentials from Vault. E*TRADE uses
	 * consumer-key/consumer-secret (OAuth 1.0a terminology) instead of
	 * client-id/client-secret (OAuth 2.0 terminology).
	 */
