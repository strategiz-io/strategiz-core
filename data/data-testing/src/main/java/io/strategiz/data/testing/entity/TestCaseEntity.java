...
/**
 * Represents an individual test case (test method)
 * Examples:
 * - Playwright: "should login with valid credentials"
 * - JUnit: "testExecutePythonStrategy_Success"
 * - pytest: "test_simple_buy_strategy"
 * Stored in: tests/apps/{appId}/modules/{moduleId}/suites/{suiteId}/tests/{testId}
 */
@Entity
...
public class TestCaseEntity extends BaseEntity {
    ...
    private String methodName; // Actual method name (e.g., "testExecutePythonStrategy_Success")
