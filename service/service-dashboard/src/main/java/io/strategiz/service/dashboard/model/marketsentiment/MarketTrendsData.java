...
public class MarketTrendsData {
    ...
    public MarketTrendsData(BigDecimal fearGreedIndex, String fearGreedCategory, 
                           BigDecimal uptrendPercentage, BigDecimal downtrendPercentage, 
                           BigDecimal neutralTrendPercentage) {
    ...
    public static class Builder {
        ...
        public MarketTrendsData build() {
            return new MarketTrendsData(fearGreedIndex, fearGreedCategory, uptrendPercentage, 
                                      downtrendPercentage, neutralTrendPercentage);
        }
    }
}
