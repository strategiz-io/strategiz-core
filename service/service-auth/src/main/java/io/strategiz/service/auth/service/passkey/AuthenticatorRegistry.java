 ...
 *
 * AAGUIDs are 128-bit identifiers that uniquely identify authenticator models.
 * This allows us to display friendly names and logos for password managers.
 *
...
public class AuthenticatorRegistry {
     ...
     */
    public record AuthenticatorInfo(
        String name,        // Human-readable name (e.g., "iCloud Keychain")
    ...
    static {
        ...
        // Dashlane
        REGISTRY.put("531126d6-e717-415c-9320-3d9aa6981240",
            new AuthenticatorInfo("Dashlane", "dashlane", "dashlane"));

        // Keeper
        REGISTRY.put("0ea242b4-43c4-4a1b-8b17-dd6d0b6baec6",
            new AuthenticatorInfo("Keeper", "keeper", "keeper"));

        // LastPass
        REGISTRY.put("fdb141b2-5d84-443e-8a35-4698c205a502",
            new AuthenticatorInfo("LastPass", "lastpass", "lastpass"));
        ...
        REGISTRY.put("2fc0579f-8113-47ea-b116-bb5a8db9202a",
            new AuthenticatorInfo("YubiKey 5", "yubikey", "yubico"));
        REGISTRY.put("73bb0cd4-e502-49b8-9c6f-b59445bf720b",
            new AuthenticatorInfo("YubiKey 5 NFC", "yubikey", "yubico"));
        REGISTRY.put("c5ef55ff-ad9a-4b9f-b580-adebafe026d0",
            new AuthenticatorInfo("YubiKey 5C", "yubikey", "yubico"));
        REGISTRY.put("85203421-48f9-4355-9bc8-8a53846e5083",
            new AuthenticatorInfo("YubiKey 5Ci", "yubikey", "yubico"));
        ...
        // Firefox
        REGISTRY.put("a4e9fc6d-4cbe-4758-b8ba-37598bb5bbaa",
            new AuthenticatorInfo("Firefox", "firefox", "mozilla"));
     ...
     */
    private static final AuthenticatorInfo DEFAULT =
        new AuthenticatorInfo("Passkey", "key", "unknown");
