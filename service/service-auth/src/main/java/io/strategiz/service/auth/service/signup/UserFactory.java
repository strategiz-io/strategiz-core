...
public class UserFactory {
	...
	/**
	 * Creates a new UserEntity populated with data from OAuth signup Uses UUID as the
	 * userId - immutable and privacy-friendly
	...
	public UserEntity createUser(OAuthSignupRequest request) {
		...
		UserProfileEntity profile = new UserProfileEntity(request.getName(), request.getEmail(), request.getPhotoURL(),
