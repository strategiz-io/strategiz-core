 ...
 *
 * Vault path: secret/strategiz/twilio Required secrets: account-sid, auth-token,
 * phone-number
 */
@Configuration
...
public class TwilioVaultConfig {
	...
	@Autowired
	public TwilioVaultConfig(@Qualifier("vaultSecretService") SecretManager secretManager,
