...
/**
 * Standard error codes with associated HTTP status codes for the Strategiz platform. These are.
 * used. to create consistent error responses across all services.
 */
