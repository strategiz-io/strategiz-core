...
/**
 * Immutable representation of an authenticated user, extracted from a PASETO token.
 * This class provides convenience methods for checking permissions and authentication levels.
 */
public final class AuthenticatedUser {
     ...
     * Also returns true if user has wildcard scope (*).
     *
    ...
    /**
     * Check if the user meets a minimum ACR level.
     * ACR levels: "0" (none) < "1" (single-factor) < "2" (MFA) < "3" (strong MFA)
     *
