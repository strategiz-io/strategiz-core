 ...
 *
 * <p>This interface abstracts the FGA (OpenFGA) operations for relationship-based authorization.
 * The current implementation is {@link FGAMockClient} which uses an in-memory store. A future
 * {@code client-openfga} module will provide a production implementation using the OpenFGA SDK.
 *
 * <p>Example usage:
 *
 * <pre>
