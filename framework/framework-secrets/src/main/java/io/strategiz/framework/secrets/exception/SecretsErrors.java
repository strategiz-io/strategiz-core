...
/**
 * Error codes for secrets framework operations. Implements ErrorDetails for integration
...
public enum SecretsErrors implements ErrorDetails {
	...
	INVALID_SECRET_KEY(HttpStatus.BAD_REQUEST, "invalid-secret-key"), SECRET_EXPIRED(HttpStatus.GONE, "secret-expired"),
