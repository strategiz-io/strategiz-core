...
/**
 * Configuration class for the Portfolio Service module. Follows Single Responsibility
 * Principle - only handles module configuration.
 */
@Configuration
@Import(BusinessPortfolioConfig.class) // Import business portfolio config which includes
										// enhancer components
