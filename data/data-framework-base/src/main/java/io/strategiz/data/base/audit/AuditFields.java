...
/**
 * Centralized audit fields for all Firestore entities.
 * This class ensures consistent audit data across all documents in the platform.
 * 
 * Usage: All Firestore entities MUST include this as an embedded field named 'auditFields'.
 * 
