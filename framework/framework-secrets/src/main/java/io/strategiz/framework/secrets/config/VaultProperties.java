...
/**
 * Configuration properties for HashiCorp Vault integration. These properties can be set
 * in application.properties/yaml files.
 */
...
public class VaultProperties {
	...
	/** Time in milliseconds for caching secret values Set to 0 to disable caching. */
