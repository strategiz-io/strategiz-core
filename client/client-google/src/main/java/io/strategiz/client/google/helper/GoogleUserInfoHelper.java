...
/**
 * Helper class for retrieving user information from Google
 * Following Single Responsibility Principle - only handles user info retrieval
 */
@Component
public class GoogleUserInfoHelper {
    ...
    private boolean isValidUserData(ResponseEntity<Map<String, Object>> response) {
        ...
        return response.getStatusCode().is2xxSuccessful() && 
               userData != null && 
               userData.containsKey("sub"); // Google uses "sub" as the user ID
    }
