...
/**
 * Manual test to verify real API data fetching.
 * Run this with: mvn spring-boot:run -Dstart-class=io.strategiz.service.marketing.ManualMarketDataTest
 */
...
public class ManualMarketDataTest {
    ...
    static class TestConfig {
        ...
        public RestTemplate alphaVantageRestTemplate(RestTemplateBuilder builder) {
            return builder
                .rootUri("https://www.alphavantage.co")
                .build();
        }
