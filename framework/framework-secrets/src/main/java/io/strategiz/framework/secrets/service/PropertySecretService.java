...
/**
 * Simple implementation that just uses Spring Environment properties. Used as a fallback
...
public class PropertySecretService implements SecretManager {
	...
	/**
	 * Creates a PropertySecretService with the given environment.
	...
	public void createSecret(String key, String value) {
		throw new StrategizException(SecretsErrors.OPERATION_NOT_SUPPORTED, "PropertySecretService",
				"Cannot store secrets in property-based implementation");
	}
	...
	public Map<String, Object> readSecretAsMap(String key) {
		throw new StrategizException(SecretsErrors.OPERATION_NOT_SUPPORTED, "PropertySecretService",
				"Complex secret data not supported in property-based implementation");
	}

	@Override
	public void updateSecret(String key, String value) {
		throw new StrategizException(SecretsErrors.OPERATION_NOT_SUPPORTED, "PropertySecretService",
				"Cannot update secrets in property-based implementation");
	}
	...
	public void deleteSecret(String key) {
		throw new StrategizException(SecretsErrors.OPERATION_NOT_SUPPORTED, "PropertySecretService",
				"Cannot delete secrets in property-based implementation");
	}
