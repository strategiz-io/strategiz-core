...
/**
 * Manager for OAuth user operations (creation, lookup) Specifically handles OAuth signup
 * flows
 */
@Component
public class OAuthUserManager {
	 ...
	 */
	public OAuthSignupResponse createOAuthUser(String email, String name, String pictureUrl, String authMethod,
			String providerId, String deviceId, String ipAddress) {
		try {
	...
	private OAuthSignupRequest buildSignupRequest(String email, String name, String pictureUrl, String authMethod,
			String providerId) {
