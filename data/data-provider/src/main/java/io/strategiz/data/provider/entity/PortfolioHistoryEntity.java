...
/**
 * Entity representing a point-in-time snapshot of a user's portfolio. Stored daily for
...
public class PortfolioHistoryEntity extends BaseEntity {
	...
	public String toString() {
		return String.format("PortfolioHistory[date=%s, userId=%s, totalValue=%s, assets=%d]", snapshotDate, userId,
