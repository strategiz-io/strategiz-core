 ...
 */
public record SmsOtpSendResponse(
    boolean success,
    String message,
    String phoneNumber,
     ...
     */
    public static SmsOtpSendResponse success(String phoneNumber, String maskedPhoneNumber, String otpId, int expiresInSeconds) {
        return new SmsOtpSendResponse(
            true,
