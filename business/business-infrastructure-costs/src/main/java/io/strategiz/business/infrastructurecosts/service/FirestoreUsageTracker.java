...
/**
 * AOP aspect for tracking Firestore read/write operations. Intercepts repository calls
 * and records usage metrics.
 *
...
public class FirestoreUsageTracker {
	...
	private String extractCollectionName(JoinPoint joinPoint) {
		...
		String baseName = className.replace("Repository", "").replace("Impl", "");
