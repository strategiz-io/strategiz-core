 ...
 */
public class ConnectedProviderEntity extends BaseEntity {
    ...
    // Constructors
    public ConnectedProviderEntity() {
        super();
    }

    public ConnectedProviderEntity(String providerType, String providerName) {
        super();
    ...
    public ConnectedProviderEntity(String providerType, String providerName, String displayName, String connectionType) {
        super();
        this.providerType = providerType;
        this.providerName = providerName;
