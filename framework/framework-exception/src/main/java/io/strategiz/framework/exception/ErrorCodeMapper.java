...
/**
 * Utility class to map ErrorCodes to HTTP status codes.
 * Provides a consistent mapping from internal error codes to HTTP response codes.
 */
public class ErrorCodeMapper {
    ...
    public static HttpStatus getHttpStatus(ErrorCode errorCode) {
        ...
        return switch (errorCode) {
            ...
            case VALIDATION_ERROR, BUSINESS_RULE_VIOLATION, DATA_INTEGRITY_ERROR -> HttpStatus.BAD_REQUEST;
