 ...
 *
 * Tracks:
 * - Who subscribed (userId/subscriberId)
 * - Which strategy (strategyId)
 * - Subscription type (FREE, ONE_TIME, SUBSCRIPTION)
...
public class StrategySubscriptionEntity extends BaseEntity {
    ...
    public boolean isValid() {
        ...
        return status == SubscriptionStatus.ACTIVE || status == SubscriptionStatus.TRIAL || status == SubscriptionStatus.CANCELLED;
    }
    ...
    public String toString() {
        return "StrategySubscriptionEntity{" +
                "id='" + id + '\'' +
