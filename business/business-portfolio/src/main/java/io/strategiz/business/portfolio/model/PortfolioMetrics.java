...
public class PortfolioMetrics implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(userId, that.userId) && Objects.equals(totalValue, that.totalValue)
				&& Objects.equals(performance, that.performance) && Objects.equals(allocation, that.allocation)
	...
	public String toString() {
		return "PortfolioMetrics{" + "userId='" + userId + '\'' + ", totalValue=" + totalValue + ", performance="
				+ performance + ", allocation=" + allocation + ", risk=" + risk + '}';
	}
