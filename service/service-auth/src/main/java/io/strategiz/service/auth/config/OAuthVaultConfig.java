...
/**
 * Configuration class that loads OAuth credentials from Vault and makes them available as
 * Spring properties.
 */
@Configuration
public class OAuthVaultConfig {
	...
	@Autowired
	public OAuthVaultConfig(@Qualifier("vaultSecretService") SecretManager secretManager,
