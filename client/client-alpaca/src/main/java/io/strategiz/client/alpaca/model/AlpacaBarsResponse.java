 ...
 *
 * Alpaca API Response Format: { "bars": [ {...}, {...}, ... ], "symbol": "AAPL",
...
public class AlpacaBarsResponse {
	...
	public String toString() {
		return String.format("AlpacaBarsResponse[symbol=%s, bars=%d, hasNextPage=%b]", symbol,
				bars != null ? bars.size() : 0, hasNextPage());
	}
