 ...
 *
 * Manages the settings that control whether an owner has subscriptions enabled,
 * their pricing, and Stripe Connect integration.
 */
public interface OwnerSubscriptionSettingsRepository {
    ...
    /**
     * Update the monthly price.
     * Note: Existing subscribers keep their grandfathered rate.
     *
     * @param userId   The owner's user ID
