...
public class MarketSentimentData {
	...
	public MarketSentimentData(List<SentimentIndicator> sentimentIndicators, List<AssetSentiment> assetSentiments,
	...
	public String toString() {
		return "MarketSentimentData{" + "sentimentIndicators=" + sentimentIndicators + ", assetSentiments="
				+ assetSentiments + ", marketTrends=" + marketTrends + '}';
	}
