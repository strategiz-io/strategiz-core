...
/**
 * Base controller for all provider-related controllers.
 * Provides common provider patterns following the clean architecture.
 * 
 * Feature controllers should extend this and return clean data objects, throwing StrategizException for errors.
 */
public abstract class ProviderBaseController {
     ...
     * Common utility for all provider controllers
     */
     ...
     * Common utility for provider OAuth
     */
     ...
     * Each provider controller must implement this
     */
