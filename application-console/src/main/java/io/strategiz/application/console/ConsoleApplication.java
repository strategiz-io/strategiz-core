 ...
 *
 * Serves admin-only endpoints at /v1/console/* and runs batch jobs.
 * Separate deployment from main API for independent scaling and updates.
 * Batch jobs can run without being killed by main API deployments.
 *
 * Endpoints served:
 * - /v1/console/jobs - Job management
 * - /v1/console/costs - Infrastructure costs
 * - /v1/console/users - User management
 * - /v1/console/providers - Provider status
 * - /v1/console/observability - System metrics
