...
/**
 * User preference for users/{userId}/preferences subcollection Each document represents a
 * preference category (theme, notifications, etc.)
 */
...
public class UserPreferenceEntity extends BaseEntity {
	...
	public UserPreferenceEntity(String category, Map<String, Object> settings) {
		super();
