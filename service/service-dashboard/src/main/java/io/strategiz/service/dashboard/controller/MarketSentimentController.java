...
/**
 * Controller for market sentiment data. Provides endpoints for retrieving market
 * sentiment and trends information. Uses clean architecture - returns resources directly,
 * no wrappers.
 */
@RestController
...
public class MarketSentimentController extends BaseController {
	 ...
	 * @return Clean market sentiment data - no wrapper, let GlobalExceptionHandler handle
	 * errors
	 */
	 ...
	 * @param userId The user ID to get data for
	 * @return Clean market trends data - no wrapper, let GlobalExceptionHandler handle
	 * errors
	 */
	@GetMapping("/trends")
