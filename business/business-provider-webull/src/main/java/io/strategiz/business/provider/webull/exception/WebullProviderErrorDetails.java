 ...
 *
 * Each error maps to properties in business-provider-webull-errors.properties file which
 * contains: - Error code - User-friendly message - Developer message template with
 * placeholders - Documentation path
 *
 * Usage: throw new StrategizException(WebullProviderErrorDetails.INVALID_CREDENTIALS,
 * "business-provider-webull", userId); throw new
 * StrategizException(WebullProviderErrorDetails.POSITIONS_FETCH_FAILED,
 * "business-provider-webull", userId, errorMessage);
 *
