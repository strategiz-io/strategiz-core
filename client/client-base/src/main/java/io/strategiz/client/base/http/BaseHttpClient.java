...
public abstract class BaseHttpClient {
	...
	/**
	 * Configures default HTTP headers for all requests. Override this method to add
	 * custom headers.
	...
	/**
	 * Handles error responses from the API. This provides consistent error handling
	 * across all API clients.
	...
	/**
	 * Validates that we're connecting to a real API endpoint, not a mock service. This
	 * enforces Strategiz's requirement to use ONLY real APIs, never mock data.
	...
	/**
	 * Gets the raw, unmodified response from the API. This follows Strategiz's preference
	 * to see exactly what comes from the API.
