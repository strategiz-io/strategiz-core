...
/**
 * Type-specific metadata schemas and validation for authentication methods Each
 * authentication method type has unique storage requirements
 */
public class AuthenticationMethodMetadata {
	...
	public static class PasskeyMetadata {
		...
		public static final String CREDENTIAL_ID = "credentialId"; // Unique credential
																	// identifier

		public static final String PUBLIC_KEY_BASE64 = "publicKeyBase64"; // Public key
																			// for
																			// verification

		public static final String SIGNATURE_COUNT = "signatureCount"; // Anti-replay
																		// counter

		public static final String AAGUID = "aaguid"; // Authenticator AAGUID

		// Device information
		public static final String DEVICE_NAME = "deviceName"; // User-friendly device
																// name

		public static final String USER_AGENT = "userAgent"; // Browser/platform info

		public static final String AUTHENTICATOR_NAME = "authenticatorName"; // Authenticator
																				// type

		// Security flags
		public static final String TRUSTED = "trusted"; // Is this a trusted authenticator

		public static final String VERIFIED = "verified"; // Has been successfully
															// verified
		...
		// WebAuthn specific
		public static final String ATTESTATION_TYPE = "attestationType"; // none, basic,
																			// self, etc.
	...
	public static class TotpMetadata {
		...
		// Backup and recovery
		public static final String BACKUP_CODES = "backupCodes"; // List of one-time
																	// backup codes

		public static final String BACKUP_CODES_USED = "backupCodesUsed"; // Used backup
																			// codes

		// QR Code generation
		public static final String QR_CODE_GENERATED = "qrCodeGenerated"; // Has QR been
																			// generated
		...
		public static final String VERIFICATION_TIME = "verificationTime"; // When
																			// verified
	...
	public static class SmsOtpMetadata {
		...
		public static final String VERIFICATION_CODE = "verificationCode"; // Last sent
																			// code
																			// (temporary)
		...
		public static final String LAST_OTP_SENT_AT = "lastOtpSentAt"; // Last OTP sent
																		// timestamp

		public static final String SMS_DELIVERY_STATUS = "smsDeliveryStatus"; // delivered,
																				// failed,
																				// pending
		...
		public static final String DAILY_COUNT_RESET_AT = "dailyCountResetAt"; // When
																				// daily
																				// count
																				// was
																				// reset

		public static final String RATE_LIMIT_EXCEEDED = "rateLimitExceeded"; // Rate
																				// limit
																				// hit
		...
		public static final String FAILED_ATTEMPTS = "failedAttempts"; // Failed
																		// verification
																		// attempts
	...
	public static class EmailOtpMetadata {
		...
		// Email delivery
		public static final String LAST_EMAIL_SENT = "lastEmailSent"; // Last email
																		// timestamp

		public static final String EMAIL_DELIVERY_STATUS = "emailDeliveryStatus"; // delivered,
																					// failed,
																					// pending

		public static final String EMAIL_PROVIDER = "emailProvider"; // SendGrid, SES,
																		// etc.
		...
		// Rate limiting
		public static final String DAILY_EMAIL_COUNT = "dailyEmailCount"; // Emails sent
																			// today

		public static final String LAST_EMAIL_DATE = "lastEmailDate"; // Date of last
																		// email
	...
	public static class OAuthMetadata {
		...
		public static final String PROVIDER_USER_ID = "providerUserId"; // User ID from
																		// provider

		public static final String EMAIL = "email"; // Email from provider

		public static final String DISPLAY_NAME = "displayName"; // Display name from
																	// provider

		public static final String PROFILE_PICTURE = "profilePicture"; // Profile picture
																		// URL

		// Tokens (encrypted/hashed)
		public static final String ACCESS_TOKEN_HASH = "accessTokenHash"; // Hashed access
																			// token

		public static final String REFRESH_TOKEN_HASH = "refreshTokenHash"; // Hashed
																			// refresh
																			// token
		...
		public static final String GRANTED_SCOPES = "grantedScopes"; // Scopes granted by
																		// user

		public static final String PROFILE_VERIFIED = "profileVerified"; // Provider
																			// verified
																			// profile

		// Connection details
		public static final String CONNECTED_TIME = "connectedTime"; // When first
																		// connected

		public static final String LAST_SYNC_TIME = "lastSyncTime"; // Last profile sync

		public static final String CONNECTION_STATUS = "connectionStatus"; // active,
																			// revoked,
																			// expired
	...
	public static class CommonMetadata {
		...
		public static final String CREATED_TIME = "createdTime"; // When method was
																	// created
	...
	public static boolean validateMetadata(AuthenticationMethodType type, Map<String, Object> metadata) {
		...
		return switch (type) {
			...
			case OAUTH_GOOGLE, OAUTH_FACEBOOK, OAUTH_MICROSOFT, OAUTH_GITHUB, OAUTH_LINKEDIN, OAUTH_TWITTER ->
	...
	private static boolean validateTotpMetadata(Map<String, Object> metadata) {
		...
		return metadata.containsKey(TotpMetadata.SECRET_KEY) && metadata.get(TotpMetadata.SECRET_KEY) instanceof String
	...
	private static boolean validateOAuthMetadata(Map<String, Object> metadata) {
		...
		return metadata.containsKey(OAuthMetadata.PROVIDER) && metadata.containsKey(OAuthMetadata.PROVIDER_USER_ID)
