...
public class BotController {
    ...
    public ResponseEntity<List<BotResponse>> getAllBots(@AuthUser String userId) {
        ...
        try {
            ...
            throw new StrategizException(LiveStrategiesErrorDetails.BOT_FETCH_FAILED, "service-my-strategies", e, new Object[0]);
        }
    }
    ...
    public ResponseEntity<BotPrerequisitesResponse> checkPrerequisites(@AuthUser String userId) {
        ...
        try {
            ...
            throw new StrategizException(LiveStrategiesErrorDetails.BOT_PREREQUISITES_CHECK_FAILED, "service-my-strategies", e, new Object[0]);
        }
    }
    ...
    public ResponseEntity<MessageResponse> createBot(
        ...
        try {
            ...
            throw new StrategizException(LiveStrategiesErrorDetails.BOT_CREATE_FAILED, "service-my-strategies", e, new Object[0]);
        }
    }
    ...
    public ResponseEntity<MessageResponse> updateBotStatus(
        ...
        try {
            ...
            throw new StrategizException(LiveStrategiesErrorDetails.BOT_UPDATE_FAILED, "service-my-strategies", e, new Object[0]);
        }
    }
    ...
    public ResponseEntity<MessageResponse> deleteBot(
        ...
        try {
            ...
            throw new StrategizException(LiveStrategiesErrorDetails.BOT_DELETE_FAILED, "service-my-strategies", e, new Object[0]);
        }
    }
    ...
    public ResponseEntity<BotPerformanceResponse> getBotPerformance(
        ...
        try {
            ...
            throw new StrategizException(LiveStrategiesErrorDetails.BOT_PERFORMANCE_FETCH_FAILED, "service-my-strategies", e, new Object[0]);
        }
    }
