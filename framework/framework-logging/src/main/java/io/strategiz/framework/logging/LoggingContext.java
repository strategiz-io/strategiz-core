...
/**
 * Thread-local context for storing logging information throughout a request. This allows
 * adding contextual information that will be available to all log statements within the
 * same thread, useful for request tracking.
 *
...
public class LoggingContext {
	...
	/**
	 * Clear the logging context Should be called at the end of request processing
	 */
