 ...
 *
 * <p>This is a singleton document - there's only one platform config at any time.</p>
 */
@Repository
    ...
    public PlatformConfig saveConfig(PlatformConfig config, String updatedBy) {
        ...
        try {
            ...
            throw new io.strategiz.data.base.exception.DataRepositoryException(
                    io.strategiz.data.base.exception.DataRepositoryErrorDetails.ENTITY_SAVE_FAILED,
                    getModuleName(), e, "PlatformConfig", config.getId());
        }
    }
