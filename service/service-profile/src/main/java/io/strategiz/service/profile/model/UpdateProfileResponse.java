...
public class UpdateProfileResponse {
    ...
    public static UpdateProfileResponse success(String userId, String message) {
        return new UpdateProfileResponse(userId, message, true, System.currentTimeMillis());
    }

    public static UpdateProfileResponse failure(String userId, String message) {
        return new UpdateProfileResponse(userId, message, false, System.currentTimeMillis());
    }
