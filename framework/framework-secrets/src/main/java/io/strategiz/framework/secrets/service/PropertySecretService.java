...
/**
 * Simple implementation that just uses Spring Environment properties. Used as a fallback when Vault
 * is disabled.
 */
@Service
public class PropertySecretService implements SecretManager {
  ...
  public void createSecret(String key, String value) {
    throw new StrategizException(
        SecretsErrors.OPERATION_NOT_SUPPORTED,
        "PropertySecretService",
