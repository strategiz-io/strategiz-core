...
public class ApiResponseWrapper<T> {
    ...
    // Error code field - added during consolidation
    ...
    @Override
    public int hashCode() {
        return Objects.hash(success, status, message, timestamp, data, errorCode);
    }
    ...
    public static class Builder<T> {
        ...
        public ApiResponseWrapper<T> build() {
            ApiResponseWrapper<T> response = new ApiResponseWrapper<>(success, status, message, timestamp, data);
     ...
     * @return An error response with the provided details
     */
    public static <T> ApiResponseWrapper<T> error(int status, String errorCode, String message) {
        return ApiResponseWrapper.<T>builder()
                .success(false)
                .status(status)
                .message(message)
